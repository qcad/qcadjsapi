  ...
  // Automatically generated, do not edit
    ...
    #include "RJSTypeEnum.h"
      ...
      class QCADJSAPI_EXPORT 
      RJSType_RLinkedStorage : public RJSTypeEnum {
          Q_OBJECT
          QML_INTERFACE
      ...
      public:
          ...
          Q_INVOKABLE
          QString getName() const {
              return "RLinkedStorage";
          }

          //RJSTypeEnum* create() {
          //    return new RJSType_RLinkedStorage();
          //}
      ...
      class QCADJSAPI_EXPORT 
      RJSType_RNewDocumentListenerAdapter : public RJSTypeEnum {
          Q_OBJECT
          QML_INTERFACE
      ...
      public:
          ...
          Q_INVOKABLE
          QString getName() const {
              return "RNewDocumentListenerAdapter";
          }

          //RJSTypeEnum* create() {
          //    return new RJSType_RNewDocumentListenerAdapter();
          //}
