  ...
  // Auto generated
    ...
    #include <QQmlEngine>
      ...
      class RPolyline_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
  ...
  a1
    ...
    class RPolyline_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RPolyline* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          qWarning() << "RPolyline_Wrapper::castToBase: type not found: " << getTypeName(t);
