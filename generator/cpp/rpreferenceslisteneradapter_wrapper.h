  ...
  // Auto generated
    ...
    #include <QQmlEngine>
     ...
     RPreferencesListenerAdapter_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
  ...
  a3
    ...
    class QCADJSAPI_EXPORT 
     RPreferencesListenerAdapter_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RPreferencesListenerAdapter* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RPreferencesListenerAdapter:
          ...
          // object is a pointer to base class RPreferencesListenerAdapter:
