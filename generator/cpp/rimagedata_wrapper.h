  ...
  // Auto generated
    ...
    #ifndef RIMAGEDATA_H_WRAPPER
    #define RIMAGEDATA_H_WRAPPER
    ...
    #include <QQmlEngine>
      ...
      public:
      //Q_INVOKABLE 
      RImageData_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RImageData_WrapperSingleton* _singleInstance;
    ...
    private:
      ...
      RImageData_Wrapper(const RImageData_Wrapper&);

    public:
      // initialization of RImageData:
      static void init(RJSApi& handler);
        ...
        static RImageData* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          qWarning() << "RImageData_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);

          return nullptr;
          
        }

        static RImageData* getWrappedBase(RJSWrapper* wrapper) {
          int t = wrapper->getWrappedType();
          void* vp = wrapper->getWrappedVoid();
          if (vp==nullptr) {
              //qWarning() << "getWrapped_RImageData*: wrapper wraps NULL";
          }

          RImageData* ret = castToBase(vp, t);
          if (ret==nullptr && vp!=nullptr) {
              qWarning() << "RImageData*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
          }
          return ret;
        }
    ...
    // special constructor used as prototype:
          ...
          Q_INVOKABLE 
          RImageData_Wrapper(QJSEngine* e);
    ...
    */
      ...
      // special constructor to wrap existing object:
            ...
            //Q_INVOKABLE 
            RImageData_Wrapper(RJSApi& h, RImageData* o, bool wrappedCreated);
          

      // destructor:
      
          virtual ~RImageData_Wrapper();
  ...
  // protected overwritten functions / events and their public invokable counterparts:
      ...
      private:
        ...
        static QList<RJSBasecaster_RImageData*> basecasters_RImageData;

      public:
        static void registerBasecaster_RImageData(RJSBasecaster_RImageData* bc) {
          basecasters_RImageData.append(bc);
        }
      
    };

    Q_DECLARE_METATYPE(RImageData_Wrapper*)

    Q_DECLARE_INTERFACE(RImageData_Wrapper, "org.qcad.RImageData_Wrapper")
