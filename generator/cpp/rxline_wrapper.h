  ...
  // Auto generated
    ...
    #include <QQmlEngine>
      ...
      class RXLine_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
      ...
      public:
      //Q_INVOKABLE 
      RXLine_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a1
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RXLine_WrapperSingleton* _singleInstance;
    ...
    class RXLine_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RXLine* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          qWarning() << "RXLine_Wrapper::castToBase: type not found: " << getTypeName(t);
