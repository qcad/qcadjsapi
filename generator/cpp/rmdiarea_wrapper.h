  ...
  // Auto generated
    ...
    #include <QQmlEngine>
     ...
     RMdiArea_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
      ...
      public:
      //Q_INVOKABLE 
      RMdiArea_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a2
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RMdiArea_WrapperSingleton* _singleInstance;
    ...
    class QCADJSAPI_EXPORT 
     RMdiArea_Wrapper : public RJSWrapperObj {
  ...
  enum AreaOption {
    DontMaximizeSubWindowOnActivation = RMdiArea::DontMaximizeSubWindowOnActivation,

  };
  Q_ENUM(AreaOption)

  enum WindowOrder {
    CreationOrder = RMdiArea::CreationOrder,
StackingOrder = RMdiArea::StackingOrder,
ActivationHistoryOrder = RMdiArea::ActivationHistoryOrder,

  };
  Q_ENUM(WindowOrder)

  enum ViewMode {
    SubWindowView = RMdiArea::SubWindowView,
TabbedView = RMdiArea::TabbedView,
  ...
  // protected overwritten functions / events and their public invokable counterparts:
      ...
      private:
        ...
        static QList<RJSBasecaster_RMdiArea*> basecasters_RMdiArea;

      public:
        static void registerBasecaster_RMdiArea(RJSBasecaster_RMdiArea* bc) {
          basecasters_RMdiArea.append(bc);
        }
