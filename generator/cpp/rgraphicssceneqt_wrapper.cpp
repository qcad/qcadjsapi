  ...
  //#include "header_cpp.h"
    ...
    */
      ...
      RGraphicsSceneQt_Wrapper::RGraphicsSceneQt_Wrapper(RJSApi& h, RGraphicsSceneQt* o, bool wrappedCreated) : RJSWrapperObj(h), wrapped(o), wrappedCreated(wrappedCreated) {
