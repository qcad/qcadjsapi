    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RDimRotatedData* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RDimRotatedData:
          ...
          // object is a pointer to base class RDimRotatedData:
          if (t==RJSType_RDimRotatedData::getIdStatic()) {
            return (RDimRotatedData*)vp;
          }

          qWarning() << "RDimRotatedData_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
