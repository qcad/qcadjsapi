  ...
  // Auto generated
    ...
    #include <QQmlEngine>
     ...
     RDockWidget_WrapperSingleton: public QObject {
      ...
      public:
      //Q_INVOKABLE 
      RDockWidget_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a2
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RDockWidget_WrapperSingleton* _singleInstance;
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RDockWidget* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          qWarning() << "RDockWidget_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
  ...
  enum DockWidgetFeature {
    DockWidgetClosable = RDockWidget::DockWidgetClosable,
DockWidgetMovable = RDockWidget::DockWidgetMovable,
DockWidgetFloatable = RDockWidget::DockWidgetFloatable,
DockWidgetVerticalTitleBar = RDockWidget::DockWidgetVerticalTitleBar,
DockWidgetFeatureMask = RDockWidget::DockWidgetFeatureMask,
NoDockWidgetFeatures = RDockWidget::NoDockWidgetFeatures,
Reserved = RDockWidget::Reserved,
  ...
  // protected overwritten functions / events and their public invokable counterparts:
      ...
      private:
        ...
        static QList<RJSBasecaster_RDockWidget*> basecasters_RDockWidget;

      public:
        static void registerBasecaster_RDockWidget(RJSBasecaster_RDockWidget* bc) {
          basecasters_RDockWidget.append(bc);
        }
