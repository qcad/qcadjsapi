  ...
  // Auto generated
    ...
    #include <QQmlEngine>
     ...
     RXLineEntity_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
  ...
  a1
    ...
    class QCADJSAPI_EXPORT 
     RXLineEntity_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RXLineEntity* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          qWarning() << "RXLineEntity_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
