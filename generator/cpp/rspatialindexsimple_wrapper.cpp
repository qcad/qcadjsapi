  ...
  //#include "header_cpp.h"
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RSpatialIndexSimple_WrapperSingleton::getSIId
              (
...
int a2_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RSpatialIndexSimple_WrapperSingleton::getId
              (
...
qint64 a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RSpatialIndexSimple_WrapperSingleton::getPos
              (
...
qint64 a1_cpp;
    ...
    void RSpatialIndexSimple_Wrapper::init(RJSApi& handler) {
      ...
      engine->globalObject().setProperty("RSpatialIndexSimple_Wrapper", mo);
        ...
        // singleton wrapper:
        QJSValue mos = engine->newQMetaObject(&RSpatialIndexSimple_WrapperSingleton::staticMetaObject);
        engine->globalObject().setProperty("RSpatialIndexSimple_WrapperSingleton", mos);

        // create instance of singleton wrapper for static functions:
        RSpatialIndexSimple_WrapperSingleton * s = new RSpatialIndexSimple_WrapperSingleton(handler);
        engine->globalObject().setProperty("RSpatialIndexSimple_WrapperSingletonInstance", engine->newQObject(s));
