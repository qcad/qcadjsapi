  ...
  // Auto generated
    ...
    #include <QQmlEngine>
      ...
      class RPluginLoader_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
  ...
  a1
    ...
    class RPluginLoader_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RPluginLoader* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          qWarning() << "RPluginLoader::castToBase: type not found: " << getTypeName(t);
