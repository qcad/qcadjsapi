  ...
  //#include "header_cpp.h"
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RLayerListenerAdapter_WrapperSingleton::tr
              (
...
int a3_cpp;
    ...
    void RLayerListenerAdapter_Wrapper::init(RJSApi& handler) {
      ...
      engine->globalObject().setProperty("RLayerListenerAdapter_Wrapper", mo);
        ...
        // singleton wrapper:
        QJSValue mos = engine->newQMetaObject(&RLayerListenerAdapter_WrapperSingleton::staticMetaObject);
        engine->globalObject().setProperty("RLayerListenerAdapter_WrapperSingleton", mos);

        // create instance of singleton wrapper for static functions:
        RLayerListenerAdapter_WrapperSingleton * s = new RLayerListenerAdapter_WrapperSingleton(handler);
        engine->globalObject().setProperty("RLayerListenerAdapter_WrapperSingletonInstance", engine->newQObject(s));
