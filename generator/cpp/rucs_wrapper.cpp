  ...
  //#include "header_cpp.h"
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RUcs_WrapperSingleton::setCustomPropertyAttributes
              (
...
RPropertyAttributes a3_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RUcs_WrapperSingleton::getCustomPropertyAttributes
              (
...
QString a2_cpp;
    ...
    void RUcs_Wrapper::init(RJSApi& handler) {
      
        //qmlRegisterType<RUcs_Wrapper>("org.qcad", 1, 0, "RUcs_Wrapper");
        qmlRegisterInterface<RUcs_Wrapper>("RUcs_Wrapper", 1);
      ...
      QJSEngine* engine = handler.getEngine();
          ...
          RJSType_RUcs* t = new RJSType_RUcs();
          global.setProperty("RJSType_RUcs", engine->newQObject(t));
      ...
      // wrapper:
      QJSValue mo = engine->newQMetaObject(&RUcs_Wrapper::staticMetaObject);
      engine->globalObject().setProperty("RUcs_Wrapper", mo);


      
        // JS base class:
        //QJSValue mob = engine->newQMetaObject(&RUcs_BaseJs::staticMetaObject);
        //engine->globalObject().setProperty("RUcs_BaseJs", mob);
      
        // singleton wrapper:
        QJSValue mos = engine->newQMetaObject(&RUcs_WrapperSingleton::staticMetaObject);
        engine->globalObject().setProperty("RUcs_WrapperSingleton", mos);

        // create instance of singleton wrapper for static functions:
        RUcs_WrapperSingleton * s = new RUcs_WrapperSingleton(handler);
        engine->globalObject().setProperty("RUcs_WrapperSingletonInstance", engine->newQObject(s));
        QJSEngine::setObjectOwnership(s, QJSEngine::CppOwnership);
      
      QString fileName = ":generator/js/RUcs.js";
    ...
    RUcs_Wrapper::RUcs_Wrapper(QJSEngine* e) : wrapped(nullptr), wrappedCreated(false) {
            //setObjectName("RUcs_Wrapper");
            setEngine(e);
    ...
    */
      ...
      RUcs_Wrapper::RUcs_Wrapper(RJSApi& h, RUcs* o, bool wrappedCreated) : RJSWrapperObj(h), wrapped(o), wrappedCreated(wrappedCreated) {
              //RDebug::incCounter(QString("RUcs_Wrapper_") + handler.getEngine()->objectName());
              //RDebug::incCounter(QString("RUcs_Wrapper"));
              //setObjectName("RUcs_Wrapper");
              //setHandler(h);
        ...
        RUcs_Wrapper::RUcs_Wrapper(RJSApi& h, QSharedPointer<RUcs> o) : RJSWrapperObj(h), wrapped(nullptr), spWrapped(o), wrappedCreated(false) {
              //RDebug::incCounter(QString("RUcs_Wrapper_") + handler.getEngine()->objectName());
              //RDebug::incCounter(QString("RUcs_Wrapper"));
              //setObjectName("RUcs_Wrapper");
              //setHandler(h);
      ...
      // destructor:
      RUcs_Wrapper::~RUcs_Wrapper() {
            //RDebug::decCounter(QString("RUcs_Wrapper_") + handler.getEngine()->objectName());
            //RDebug::decCounter(QString("RUcs_Wrapper"));

            //qDebug() << "RUcs_Wrapper::~RUcs_Wrapper";
            ...
            if (wrappedCreated) {
                  ...
                  //qDebug() << "NOT deleting instance of RUcs";
    ...
    // initialization of signal forwarding
        ...
        void RUcs_Wrapper::initConnections() {
...
RVector a3_cpp;
  ...
  // convert js parameter to cpp: xAxisDirection (RVector)
  
RVector a4_cpp;

      a4_cpp = RJSHelper_qcad::js2cpp_RVector(handler, a4);
        
  // convert js parameter to cpp: yAxisDirection (RVector)
...
RVector a5_cpp;
   ...
   && a5.isUndefined()
                  ...
                  qWarning() << "no matching constructor variant found for RUcs";
                  wrapped = nullptr;
                  wrappedCreated = false;
                  handler.trace();
...
bool a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RUcs_Wrapper::getPropertyTypeIds
              (
...
RPropertyAttributes::Option a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RUcs_Wrapper::getCustomPropertyTypeIds
              (
...
RPropertyTypeId a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RUcs_Wrapper::hasCustomProperties
              (
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RUcs_Wrapper::hasCustomProperty
              (
...
QString a2_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RUcs_Wrapper::getCustomProperty
              (
...
QVariant a3_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RUcs_Wrapper::getCustomDoubleProperty
              (
...
double a3_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RUcs_Wrapper::getCustomIntProperty
              (
...
int a3_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RUcs_Wrapper::getCustomBoolProperty
              (
...
bool a3_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RUcs_Wrapper::setCustomProperty
              (
...
QVariant a3_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RUcs_Wrapper::removeCustomProperty
              (
...
QString a2_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RUcs_Wrapper::getCustomPropertyTitles
              (
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RUcs_Wrapper::getCustomPropertyKeys
              (
...
QString a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RUcs_Wrapper::copyCustomPropertiesFrom
              (
...
QString a6_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RUcs_Wrapper::setAutoUpdatesBlocked
              (
...
bool a1_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return RJSHelper_qcad::cpp2js_RUcs(
              handler, 
              // non-copyable: true
                  res
...
RVector a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RUcs_Wrapper::setXAxisDirection
              (
  ...
  // convert js parameter to cpp: x (RVector)
...
RVector a1_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return QJSValue();
                  ...
                  qWarning() << "no matching function variant found for setXAxisDirection";
                  handler.trace();
                  return QJSValue();
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RUcs_Wrapper::setYAxisDirection
              (
  ...
  // convert js parameter to cpp: y (RVector)
...
RVector a1_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return QJSValue();
                  ...
                  qWarning() << "no matching function variant found for setYAxisDirection";
                  handler.trace();
                  return QJSValue();
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RUcs_Wrapper::getZAxisDirection
              (
          ...
          if (!hasWrapped()) {
            ...
            return RJSHelper_qcad::cpp2js_RVector(
              ...
              // non-copyable: false
                  ...
                  qWarning() << "no matching function variant found for getZAxisDirection";
                  handler.trace();
                  return QJSValue();
...
RVector a1_cpp;
          ...
          if (!hasWrapped()) {
            ...
            return RJSHelper_qcad::cpp2js_RVector(
              ...
              // non-copyable: false
                  ...
                  qWarning() << "no matching function variant found for mapFromUcs";
                  handler.trace();
                  return QJSValue();
  ...
  // convert js parameter to cpp: positionWcs (RVector)
          ...
          if (!hasWrapped()) {
            ...
            return RJSHelper_qcad::cpp2js_RVector(
              ...
              // non-copyable: false
                  ...
                  qWarning() << "no matching function variant found for mapToUcs";
                  handler.trace();
                  return QJSValue();
