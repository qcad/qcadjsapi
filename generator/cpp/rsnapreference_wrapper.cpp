  ...
  // include header:
  //#include "RSnapReferencewrapper.h"
  //#include "header_cpp.h"
    ...
    #include "rsnapreference_wrapper.h"
      ...
      QList<RJSBasecaster_RSnapReference*> RSnapReference_Wrapper::basecasters_RSnapReference;
    
    // static functions implementation in singleton wrapper:
    
    void RSnapReference_Wrapper::init(RJSApi& handler) {
      
        //qmlRegisterType<RSnapReference_Wrapper>("org.qcad", 1, 0, "RSnapReference_Wrapper");
        qmlRegisterInterface<RSnapReference_Wrapper>("RSnapReference_Wrapper", 1);
      ...
      QJSEngine* engine = handler.getEngine();
          ...
          RJSType_RSnapReference* t = new RJSType_RSnapReference();
          global.setProperty("RJSType_RSnapReference", engine->newQObject(t));
      ...
      // wrapper:
      QJSValue mo = engine->newQMetaObject(&RSnapReference_Wrapper::staticMetaObject);
      engine->globalObject().setProperty("RSnapReference_Wrapper", mo);


      
        // JS base class:
        //QJSValue mob = engine->newQMetaObject(&RSnapReference_BaseJs::staticMetaObject);
        //engine->globalObject().setProperty("RSnapReference_BaseJs", mob);
      
      QString fileName = ":generator/js/RSnapReference.js";
    ...
    RSnapReference_Wrapper::RSnapReference_Wrapper(QJSEngine* e) : wrapped(nullptr), wrappedCreated(false) {
    ...
    */
      ...
      // destructor:
      RSnapReference_Wrapper::~RSnapReference_Wrapper() {
            //RDebug::decCounter(QString("RSnapReference_Wrapper_") + handler.getEngine()->objectName());
            //RDebug::decCounter(QString("RSnapReference_Wrapper"));

            //qDebug() << "RSnapReference_Wrapper::~RSnapReference_Wrapper";
            ...
            if (wrappedCreated) {
                  ...
                  //qDebug() << "NOT deleting instance of RSnapReference";
    ...
    // initialization of signal forwarding
        ...
        void RSnapReference_Wrapper::initConnections() {
...
RSnapReference_Wrapper::RSnapReference_Wrapper
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                // call function of RSnapReference_Base class as 
                // function has postfix inheritable class, overridable function):
                RSnapReference_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "RSnapReference::showUiOptions: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                RSnapReference_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "RSnapReference::hideUiOptions: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RSnapReference_Wrapper::suspendEvent
              (
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RSnapReference_Wrapper::finishEvent
              (
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RSnapReference_Wrapper::getEntityIds
              (
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RSnapReference_Wrapper::getStatus
              (
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RSnapReference_Wrapper::setStatus
              (
...
RSnap::Status a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RSnapReference_Wrapper::getLastSnap
              (
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RSnapReference_Wrapper::setLastSnap
              (
...
double a3_cpp;
  ...
  // protected overwritten functions / events and their public invokable counterparts:
    ...
    #include "moc_rsnapreference_wrapper.cpp"
