...
Qt::WidgetAttribute a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RDockWidget_Wrapper::paintEngine
              (
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                // call function of RDockWidget_Base class as 
                // function has postfix inheritable class, overridable function):
                RDockWidget_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "RDockWidget::mousePressEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                RDockWidget_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "RDockWidget::mouseReleaseEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                RDockWidget_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "RDockWidget::paintEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                RDockWidget_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "RDockWidget::mouseMoveEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                RDockWidget_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "RDockWidget::resizeEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
