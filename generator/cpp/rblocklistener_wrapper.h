  ...
  // Auto generated
    ...
    class QCADJSAPI_EXPORT 
     RBlockListener_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RBlockListener* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RBlockListener:
          ...
          // object is a pointer to base class RBlockListener:
