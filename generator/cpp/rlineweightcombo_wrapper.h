  ...
  // Auto generated
    ...
    #include <QQmlEngine>
     ...
     RLineweightCombo_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
      ...
      public:
      //Q_INVOKABLE 
      RLineweightCombo_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a2
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RLineweightCombo_WrapperSingleton* _singleInstance;
    ...
    class QCADJSAPI_EXPORT 
     RLineweightCombo_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RLineweightCombo* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RLineweightCombo:
          for (int i=0; i<basecasters_RLineweightCombo.length(); i++) {
            RJSBasecaster_RLineweightCombo* basecaster = basecasters_RLineweightCombo[i];
            RLineweightCombo* ret = basecaster->castToBase(t, vp);
            if (ret!=nullptr) {
              return ret;
            }
          }

          // object is a pointer to base class RLineweightCombo:
          if (t==RJSType_RLineweightCombo::getIdStatic()) {
            return (RLineweightCombo*)vp;
          }

          qWarning() << "RLineweightCombo_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
  ...
  enum InsertPolicy {
    NoInsert = RLineweightCombo::NoInsert,
InsertAtTop = RLineweightCombo::InsertAtTop,
InsertAtCurrent = RLineweightCombo::InsertAtCurrent,
InsertAtBottom = RLineweightCombo::InsertAtBottom,
InsertAfterCurrent = RLineweightCombo::InsertAfterCurrent,
InsertBeforeCurrent = RLineweightCombo::InsertBeforeCurrent,
InsertAlphabetically = RLineweightCombo::InsertAlphabetically,

  };
  Q_ENUM(InsertPolicy)

  enum SizeAdjustPolicy {
    AdjustToContents = RLineweightCombo::AdjustToContents,
AdjustToContentsOnFirstShow = RLineweightCombo::AdjustToContentsOnFirstShow,
AdjustToMinimumContentsLengthWithIcon = RLineweightCombo::AdjustToMinimumContentsLengthWithIcon,
  ...
  // protected overwritten functions / events and their public invokable counterparts:
      ...
      private:
        ...
        static QList<RJSBasecaster_RLineweightCombo*> basecasters_RLineweightCombo;

      public:
        static void registerBasecaster_RLineweightCombo(RJSBasecaster_RLineweightCombo* bc) {
          basecasters_RLineweightCombo.append(bc);
        }
