  ...
  // Auto generated
    ...
    #include <QQmlEngine>
      ...
      class RSolidData_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
      ...
      public:
      //Q_INVOKABLE 
      RSolidData_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a1
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RSolidData_WrapperSingleton* _singleInstance;
    ...
    class RSolidData_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RSolidData* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          qWarning() << "RSolidData::castToBase: type not found: " << getTypeName(t);
