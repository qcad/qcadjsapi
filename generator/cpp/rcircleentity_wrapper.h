  ...
  // Auto generated
    ...
    #ifndef RCIRCLEENTITY_H_WRAPPER
    #define RCIRCLEENTITY_H_WRAPPER
    ...
    #include <QQmlEngine>
      ...
      class RCircleEntity_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
  ...
  Q_PROPERTY(
    ...
    QJSValue
     PropertyTotalArea
      ...
      public:
      //Q_INVOKABLE 
      RCircleEntity_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  Q_INVOKABLE QJSValue getPropertyLinetypeScale() {
    return RJSHelper_qcad::cpp2js_RPropertyTypeId(handler, RCircleEntity::PropertyLinetypeScale);
  }

  // auto generated read function for public static property PropertyLineweight:
  Q_INVOKABLE QJSValue getPropertyLineweight() {
    return RJSHelper_qcad::cpp2js_RPropertyTypeId(handler, RCircleEntity::PropertyLineweight);
  }

  // auto generated read function for public static property PropertyColor:
  Q_INVOKABLE QJSValue getPropertyColor() {
    return RJSHelper_qcad::cpp2js_RPropertyTypeId(handler, RCircleEntity::PropertyColor);
  }
  ...
  Q_INVOKABLE QJSValue getPropertyCircumference() {
    return RJSHelper_qcad::cpp2js_RPropertyTypeId(handler, RCircleEntity::PropertyCircumference);
  }

  // auto generated read function for public static property PropertyArea:
  Q_INVOKABLE QJSValue getPropertyArea() {
    return RJSHelper_qcad::cpp2js_RPropertyTypeId(handler, RCircleEntity::PropertyArea);
  }

  // auto generated read function for public static property PropertyTotalArea:
  Q_INVOKABLE QJSValue getPropertyTotalArea() {
    return RJSHelper_qcad::cpp2js_RPropertyTypeId(handler, RCircleEntity::PropertyTotalArea);
  }
  ...
  a1
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RCircleEntity_WrapperSingleton* _singleInstance;
    ...
    // wrapper class for RCircleEntity
    class RCircleEntity_Wrapper : public RJSWrapperObj {
    ...
    private:
      ...
      RCircleEntity_Wrapper(const RCircleEntity_Wrapper&);

    public:
      // initialization of RCircleEntity:
      static void init(RJSApi& handler);
        ...
        static RCircleEntity* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RCircleEntity:
          ...
          // object is a pointer to base class RCircleEntity:
          if (t==RJSType_RCircleEntity::getIdStatic()) {
            return (RCircleEntity*)vp;
          }

          qWarning() << "RCircleEntity_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);

          return nullptr;
          
        }

        static RCircleEntity* getWrappedBase(RJSWrapper* wrapper) {
          int t = wrapper->getWrappedType();
          void* vp = wrapper->getWrappedVoid();
          if (vp==nullptr) {
              //qWarning() << "getWrapped_RCircleEntity*: wrapper wraps NULL";
          }

          RCircleEntity* ret = castToBase(vp, t);
          if (ret==nullptr && vp!=nullptr) {
              qWarning() << "RCircleEntity*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
          }
          return ret;
        }
    ...
    // special constructor used as prototype:
          ...
          Q_INVOKABLE 
          RCircleEntity_Wrapper(QJSEngine* e);
    ...
    */
      ...
      // special constructor to wrap existing object:
            ...
            //Q_INVOKABLE 
            RCircleEntity_Wrapper(RJSApi& h, RCircleEntity* o, bool wrappedCreated);
          
        // special constructor to wrap existing object from shared pointer:
        
            //Q_INVOKABLE 
            RCircleEntity_Wrapper(RJSApi& h, QSharedPointer<RCircleEntity> o);
          

      // destructor:
      
          virtual ~RCircleEntity_Wrapper();
  ...
  // protected overwritten functions / events and their public invokable counterparts:
        ...
        RCircleEntity* getWrapped() const {
          if (wrapped!=nullptr) {
            return wrapped;
          }
        ...
        virtual QSharedPointer<RCircleEntity> getWrappedSp() {
          if (!spWrapped.isNull()) {
            return spWrapped;
          }
          if (wrapped!=nullptr) {
            qWarning() << "wrapper does not wrap a QSharedPointer<RCircleEntity> but a regular pointer";
        ...
        private:
        // wrapped object:
        RCircleEntity* wrapped;

        
          // wrapped object as shared pointer:
          QSharedPointer<RCircleEntity> spWrapped;
    ...
    Q_DECLARE_METATYPE(RCircleEntity_Wrapper*)

    Q_DECLARE_INTERFACE(RCircleEntity_Wrapper, "org.qcad.RCircleEntity_Wrapper")
