  ...
  // Auto generated
    ...
    #ifndef RLAYOUT_H_WRAPPER
    #define RLAYOUT_H_WRAPPER
    ...
    #include <QQmlEngine>
      ...
      class RLayout_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
  ...
  Q_PROPERTY(
    ...
    QJSValue
     PropertyInvisible
      ...
      public:
      //Q_INVOKABLE 
      RLayout_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a2
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RLayout_WrapperSingleton* _singleInstance;
    ...
    // wrapper class for RLayout
    class RLayout_Wrapper : public RJSWrapperObj {
    ...
    private:
      ...
      RLayout_Wrapper(const RLayout_Wrapper&);

    public:
      // initialization of RLayout:
      static void init(RJSApi& handler);
        ...
        static RLayout* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          qWarning() << "RLayout_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);

          return nullptr;
          
        }

        static RLayout* getWrappedBase(RJSWrapper* wrapper) {
          int t = wrapper->getWrappedType();
          void* vp = wrapper->getWrappedVoid();
          if (vp==nullptr) {
              //qWarning() << "getWrapped_RLayout*: wrapper wraps NULL";
          }

          RLayout* ret = castToBase(vp, t);
          if (ret==nullptr && vp!=nullptr) {
              qWarning() << "RLayout*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
          }
          return ret;
        }
    ...
    */
      ...
      // special constructor to wrap existing object:
            ...
            //Q_INVOKABLE 
            RLayout_Wrapper(RJSApi& h, RLayout* o, bool wrappedCreated);
          
        // special constructor to wrap existing object from shared pointer:
        
            //Q_INVOKABLE 
            RLayout_Wrapper(RJSApi& h, QSharedPointer<RLayout> o);
          

      // destructor:
      
          virtual ~RLayout_Wrapper();
  ...
  // protected overwritten functions / events and their public invokable counterparts:
        ...
        virtual QSharedPointer<RLayout> getWrappedSp() {
          if (!spWrapped.isNull()) {
            return spWrapped;
          }
          if (wrapped!=nullptr) {
            qWarning() << "wrapper does not wrap a QSharedPointer<RLayout> but a regular pointer";
        ...
        RLayout* wrapped;
          ...
          QSharedPointer<RLayout> spWrapped;
      ...
      private:
        ...
        static QList<RJSBasecaster_RLayout*> basecasters_RLayout;

      public:
        static void registerBasecaster_RLayout(RJSBasecaster_RLayout* bc) {
          basecasters_RLayout.append(bc);
        }
      
    };

    Q_DECLARE_METATYPE(RLayout_Wrapper*)

    Q_DECLARE_INTERFACE(RLayout_Wrapper, "org.qcad.RLayout_Wrapper")
