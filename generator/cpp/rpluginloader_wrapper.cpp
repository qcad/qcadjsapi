  ...
  //#include "header_cpp.h"
    ...
    #include "rpluginloader_wrapper.h"
      ...
      QList<RJSBasecaster_RPluginLoader*> RPluginLoader_Wrapper::basecasters_RPluginLoader;
...
QString a1_cpp;
  ...
  // convert js parameter to cpp: plugin (QObject)
    ...
    */
      ...
      RPluginLoader_Wrapper::RPluginLoader_Wrapper(RJSApi& h, RPluginLoader* o, bool wrappedCreated) : RJSWrapperObj(h), 
