  ...
  //#include "header_cpp.h"
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RGraphicsViewQt_WrapperSingleton::tr
              (
...
int a3_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RGraphicsViewQt_WrapperSingleton::setTabOrder
              (
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RGraphicsViewQt_WrapperSingleton::mouseGrabber
              (
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RGraphicsViewQt_WrapperSingleton::keyboardGrabber
              (
    ...
    void RGraphicsViewQt_Wrapper::init(RJSApi& handler) {
      ...
      engine->globalObject().setProperty("RGraphicsViewQt_Wrapper", mo);
        ...
        // singleton wrapper:
        QJSValue mos = engine->newQMetaObject(&RGraphicsViewQt_WrapperSingleton::staticMetaObject);
        engine->globalObject().setProperty("RGraphicsViewQt_WrapperSingleton", mos);

        // create instance of singleton wrapper for static functions:
        RGraphicsViewQt_WrapperSingleton * s = new RGraphicsViewQt_WrapperSingleton(handler);
        engine->globalObject().setProperty("RGraphicsViewQt_WrapperSingletonInstance", engine->newQObject(s));
