  ...
  // Auto generated
    ...
    #include <QQmlEngine>
      ...
      class RAttributeDefinitionData_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
  ...
  a3
    ...
    class RAttributeDefinitionData_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RAttributeDefinitionData* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          qWarning() << "RAttributeDefinitionData_Wrapper::castToBase: type not found: " << getTypeName(t);
