  ...
  // Auto generated
    ...
    #include <QQmlEngine>
     ...
     RLineData_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
    ...
    class QCADJSAPI_EXPORT 
     RLineData_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RLineData* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RLineData:
          ...
          // object is a pointer to base class RLineData:
          if (t==RJSType_RLineData::getIdStatic()) {
            return (RLineData*)vp;
          }

          qWarning() << "RLineData_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
