  ...
  // Auto generated
    ...
    #include <QQmlEngine>
     ...
     RWidget_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
      ...
      public:
      //Q_INVOKABLE 
      RWidget_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a2
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RWidget_WrapperSingleton* _singleInstance;
    ...
    class QCADJSAPI_EXPORT 
     RWidget_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RWidget* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RWidget:
          for (int i=0; i<basecasters_RWidget.length(); i++) {
            RJSBasecaster_RWidget* basecaster = basecasters_RWidget[i];
            RWidget* ret = basecaster->castToBase(t, vp);
            if (ret!=nullptr) {
              return ret;
            }
          }

          // object is a pointer to base class RWidget:
          if (t==RJSType_RWidget::getIdStatic()) {
            return (RWidget*)vp;
          }

          qWarning() << "RWidget_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
  ...
  // protected overwritten functions / events and their public invokable counterparts:
      ...
      private:
        ...
        static QList<RJSBasecaster_RWidget*> basecasters_RWidget;

      public:
        static void registerBasecaster_RWidget(RJSBasecaster_RWidget* bc) {
          basecasters_RWidget.append(bc);
        }
