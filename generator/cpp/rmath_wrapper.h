  ...
  // Auto generated
    ...
    #ifndef RMATH_H_WRAPPER
    #define RMATH_H_WRAPPER
    ...
    #include <QQmlEngine>
      ...
      public:
      //Q_INVOKABLE 
      RMath_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a1
      ...
      private:
          RJSApi& handler;
          //static RMath_WrapperSingleton* _singleInstance;
    ...
    private:
      ...
      RMath_Wrapper(const RMath_Wrapper&);

    public:
      // initialization of RMath:
      static void init(RJSApi& handler);
        ...
        static RMath* getWrappedBase(RJSWrapper* wrapper) {
          int t = wrapper->getWrappedType();
          void* vp = wrapper->getWrappedVoid();
          if (vp==nullptr) {
              //qWarning() << "getWrapped_RMath*: wrapper wraps NULL";
          }

          RMath* ret = castToBase(vp, t);
          if (ret==nullptr && vp!=nullptr) {
              qWarning() << "RMath*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
          }
          return ret;
        }
    ...
    */
      ...
      // special constructor to wrap existing object:
            ...
            //Q_INVOKABLE 
            RMath_Wrapper(RJSApi& h, RMath* o, bool wrappedCreated);
          

      // destructor:
      
          virtual ~RMath_Wrapper();
  ...
  // protected overwritten functions / events and their public invokable counterparts:
    ...
    Q_DECLARE_METATYPE(RMath_Wrapper*)

    Q_DECLARE_INTERFACE(RMath_Wrapper, "org.qcad.RMath_Wrapper")
