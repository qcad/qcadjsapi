  ...
  // Auto generated
    ...
    #include <QQmlEngine>
     ...
     RGraphicsViewQt_WrapperSingleton: public QObject {
      ...
      public:
      //Q_INVOKABLE 
      RGraphicsViewQt_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a2
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RGraphicsViewQt_WrapperSingleton* _singleInstance;
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RGraphicsViewQt* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RGraphicsViewQt:
          for (int i=0; i<basecasters_RGraphicsViewQt.length(); i++) {
            RJSBasecaster_RGraphicsViewQt* basecaster = basecasters_RGraphicsViewQt[i];
            RGraphicsViewQt* ret = basecaster->castToBase(t, vp);
            if (ret!=nullptr) {
              return ret;
            }
          }

          // object is a pointer to base class RGraphicsViewQt:
          if (t==RJSType_RGraphicsViewQt::getIdStatic()) {
            return (RGraphicsViewQt*)vp;
          }

          qWarning() << "RGraphicsViewQt_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
  ...
  // protected overwritten functions / events and their public invokable counterparts:
      ...
      private:
        ...
        static QList<RJSBasecaster_RGraphicsViewQt*> basecasters_RGraphicsViewQt;

      public:
        static void registerBasecaster_RGraphicsViewQt(RJSBasecaster_RGraphicsViewQt* bc) {
          basecasters_RGraphicsViewQt.append(bc);
        }
