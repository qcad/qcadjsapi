  ...
  // Auto generated
    ...
    #include <QQmlEngine>
     ...
     RToolButton_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
      ...
      public:
      //Q_INVOKABLE 
      RToolButton_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a2
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RToolButton_WrapperSingleton* _singleInstance;
    ...
    class QCADJSAPI_EXPORT 
     RToolButton_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RToolButton* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          qWarning() << "RToolButton_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
  ...
  // protected overwritten functions / events and their public invokable counterparts:
      ...
      private:
        ...
        static QList<RJSBasecaster_RToolButton*> basecasters_RToolButton;

      public:
        static void registerBasecaster_RToolButton(RJSBasecaster_RToolButton* bc) {
          basecasters_RToolButton.append(bc);
        }
