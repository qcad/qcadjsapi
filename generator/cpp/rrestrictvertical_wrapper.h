  ...
  // Auto generated
    ...
    class QCADJSAPI_EXPORT 
     RRestrictVertical_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RRestrictVertical* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RRestrictVertical:
          ...
          // object is a pointer to base class RRestrictVertical:
