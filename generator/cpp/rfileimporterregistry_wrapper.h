  ...
  // Auto generated
    ...
    #include <QQmlEngine>
      ...
      class RFileImporterRegistry_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
  ...
  a2
    ...
    class RFileImporterRegistry_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RFileImporterRegistry* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          qWarning() << "RFileImporterRegistry_Wrapper::castToBase: type not found: " << getTypeName(t);
