  ...
  // Auto generated
    ...
    #ifndef RTEXTBASEDDATA_H_WRAPPER
    #define RTEXTBASEDDATA_H_WRAPPER
    ...
    #include <QQmlEngine>
      ...
      class RTextBasedData_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
      ...
      public:
      //Q_INVOKABLE 
      RTextBasedData_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a3
      ...
      private:
          RJSApi& handler;
          //static RTextBasedData_WrapperSingleton* _singleInstance;
    ...
    // wrapper class for RTextBasedData
    class RTextBasedData_Wrapper : public RJSWrapperObj {
    ...
    private:
      ...
      RTextBasedData_Wrapper(const RTextBasedData_Wrapper&);

    public:
      // initialization of RTextBasedData:
      static void init(RJSApi& handler);
        ...
        static RTextBasedData* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          qWarning() << "RTextBasedData_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);

          return nullptr;
          
        }

        static RTextBasedData* getWrappedBase(RJSWrapper* wrapper) {
          int t = wrapper->getWrappedType();
          void* vp = wrapper->getWrappedVoid();
          if (vp==nullptr) {
              //qWarning() << "getWrapped_RTextBasedData*: wrapper wraps NULL";
          }

          RTextBasedData* ret = castToBase(vp, t);
          if (ret==nullptr && vp!=nullptr) {
              qWarning() << "RTextBasedData*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
          }
          return ret;
        }
  ...
  enum TextFlag {
    NoFlags = RTextBasedData::NoFlags,
Bold = RTextBasedData::Bold,
Italic = RTextBasedData::Italic,
Simple = RTextBasedData::Simple,
DimensionLabel = RTextBasedData::DimensionLabel,
Highlighted = RTextBasedData::Highlighted,
Backward = RTextBasedData::Backward,
UpsideDown = RTextBasedData::UpsideDown,
  ...
  Q_ENUM(TextFlag)
    ...
    // special constructor used as prototype:
          ...
          Q_INVOKABLE 
          RTextBasedData_Wrapper(QJSEngine* e);
    ...
    */
      ...
      // special constructor to wrap existing object:
            ...
            //Q_INVOKABLE 
            RTextBasedData_Wrapper(RJSApi& h, RTextBasedData* o, bool wrappedCreated);
          

      // destructor:
      
          virtual ~RTextBasedData_Wrapper();
  ...
  // protected overwritten functions / events and their public invokable counterparts:
    ...
    Q_DECLARE_METATYPE(RTextBasedData_Wrapper*)

    Q_DECLARE_INTERFACE(RTextBasedData_Wrapper, "org.qcad.RTextBasedData_Wrapper")
