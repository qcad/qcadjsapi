  ...
  // Auto generated
    ...
    #include <QQmlEngine>
     ...
     RBlockListenerAdapter_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
      ...
      public:
      //Q_INVOKABLE 
      RBlockListenerAdapter_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a3
      ...
      private:
          RJSApi& handler;
          //static RBlockListenerAdapter_WrapperSingleton* _singleInstance;
    ...
    class QCADJSAPI_EXPORT 
     RBlockListenerAdapter_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RBlockListenerAdapter* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          qWarning() << "RBlockListenerAdapter_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
  ...
  // protected overwritten functions / events and their public invokable counterparts:
      ...
      private:
        ...
        static QList<RJSBasecaster_RBlockListenerAdapter*> basecasters_RBlockListenerAdapter;

      public:
        static void registerBasecaster_RBlockListenerAdapter(RJSBasecaster_RBlockListenerAdapter* bc) {
          basecasters_RBlockListenerAdapter.append(bc);
        }
