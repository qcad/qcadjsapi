  ...
  // Auto generated
    ...
    #ifndef RGUIACTION_H_WRAPPER
    #define RGUIACTION_H_WRAPPER
    ...
    #include <QQmlEngine>
      ...
      class RGuiAction_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
      ...
      public:
      //Q_INVOKABLE 
      RGuiAction_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a1
      ...
      private:
          RJSApi& handler;
          //static RGuiAction_WrapperSingleton* _singleInstance;
    ...
    // wrapper class for RGuiAction
    class RGuiAction_Wrapper : public RJSWrapperObj {
  ...
  Q_PROPERTY(
    ...
    private:
      ...
      RGuiAction_Wrapper(const RGuiAction_Wrapper&);

    public:
      // initialization of RGuiAction:
      static void init(RJSApi& handler);
        ...
        static RGuiAction* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RGuiAction:
          ...
          // object is a pointer to base class RGuiAction:
        ...
        static RGuiAction* getWrappedBase(RJSWrapper* wrapper) {
          int t = wrapper->getWrappedType();
          void* vp = wrapper->getWrappedVoid();
          if (vp==nullptr) {
              //qWarning() << "getWrapped_RGuiAction*: wrapper wraps NULL";
          }

          RGuiAction* ret = castToBase(vp, t);
          if (ret==nullptr && vp!=nullptr) {
              qWarning() << "RGuiAction*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
          }
          return ret;
        }
...
HighPriority = RGuiAction::HighPriority,
  ...
  Q_ENUM(Priority)
    ...
    // special constructor used as prototype:
          ...
          Q_INVOKABLE 
          RGuiAction_Wrapper(QJSEngine* e);
    ...
    */
      ...
      // special constructor to wrap existing object:
            ...
            //Q_INVOKABLE 
            RGuiAction_Wrapper(RJSApi& h, RGuiAction* o, bool wrappedCreated);
          

      // destructor:
      
          virtual ~RGuiAction_Wrapper();
  ...
  // protected overwritten functions / events and their public invokable counterparts:
    ...
    Q_DECLARE_METATYPE(RGuiAction_Wrapper*)

    Q_DECLARE_INTERFACE(RGuiAction_Wrapper, "org.qcad.RGuiAction_Wrapper")
