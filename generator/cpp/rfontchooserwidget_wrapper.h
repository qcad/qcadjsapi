  ...
  // Auto generated
    ...
    #include <QQmlEngine>
     ...
     RFontChooserWidget_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
      ...
      public:
      //Q_INVOKABLE 
      RFontChooserWidget_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a2
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RFontChooserWidget_WrapperSingleton* _singleInstance;
    ...
    class QCADJSAPI_EXPORT 
     RFontChooserWidget_Wrapper : public RJSWrapperObj {
  ...
  // protected overwritten functions / events and their public invokable counterparts:
      ...
      private:
        ...
        static QList<RJSBasecaster_RFontChooserWidget*> basecasters_RFontChooserWidget;

      public:
        static void registerBasecaster_RFontChooserWidget(RJSBasecaster_RFontChooserWidget* bc) {
          basecasters_RFontChooserWidget.append(bc);
        }
