  ...
  // Auto generated
    ...
    #include <QQmlEngine>
     ...
     RColorCombo_WrapperSingleton: public QObject {
      ...
      public:
      //Q_INVOKABLE 
      RColorCombo_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a2
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RColorCombo_WrapperSingleton* _singleInstance;
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RColorCombo* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          qWarning() << "RColorCombo_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
  ...
  enum InsertPolicy {
    NoInsert = RColorCombo::NoInsert,
InsertAtTop = RColorCombo::InsertAtTop,
InsertAtCurrent = RColorCombo::InsertAtCurrent,
InsertAtBottom = RColorCombo::InsertAtBottom,
InsertAfterCurrent = RColorCombo::InsertAfterCurrent,
InsertBeforeCurrent = RColorCombo::InsertBeforeCurrent,
InsertAlphabetically = RColorCombo::InsertAlphabetically,

  };
  Q_ENUM(InsertPolicy)

  enum SizeAdjustPolicy {
    AdjustToContents = RColorCombo::AdjustToContents,
AdjustToContentsOnFirstShow = RColorCombo::AdjustToContentsOnFirstShow,
AdjustToMinimumContentsLengthWithIcon = RColorCombo::AdjustToMinimumContentsLengthWithIcon,
  ...
  // protected overwritten functions / events and their public invokable counterparts:
      ...
      private:
        ...
        static QList<RJSBasecaster_RColorCombo*> basecasters_RColorCombo;

      public:
        static void registerBasecaster_RColorCombo(RJSBasecaster_RColorCombo* bc) {
          basecasters_RColorCombo.append(bc);
        }
