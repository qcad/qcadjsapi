  ...
  // Auto generated
    ...
    #ifndef RSPLINE_H_WRAPPER
    #define RSPLINE_H_WRAPPER
    ...
    #include <QQmlEngine>
      ...
      class RSpline_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
      ...
      public:
      //Q_INVOKABLE 
      RSpline_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a3
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RSpline_WrapperSingleton* _singleInstance;
    ...
    // wrapper class for RSpline
    class RSpline_Wrapper : public RJSWrapperObj {
    ...
    private:
      ...
      RSpline_Wrapper(const RSpline_Wrapper&);

    public:
      // initialization of RSpline:
      static void init(RJSApi& handler);
        ...
        static RSpline* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          qWarning() << "RSpline_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);

          return nullptr;
          
        }

        static RSpline* getWrappedBase(RJSWrapper* wrapper) {
          int t = wrapper->getWrappedType();
          void* vp = wrapper->getWrappedVoid();
          if (vp==nullptr) {
              //qWarning() << "getWrapped_RSpline*: wrapper wraps NULL";
          }

          RSpline* ret = castToBase(vp, t);
          if (ret==nullptr && vp!=nullptr) {
              qWarning() << "RSpline*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
          }
          return ret;
        }
  ...
  enum Type {
    Unknown = RSpline::Unknown,
Point = RSpline::Point,
Line = RSpline::Line,
Arc = RSpline::Arc,
Circle = RSpline::Circle,
Ellipse = RSpline::Ellipse,
Polyline = RSpline::Polyline,
Spline = RSpline::Spline,
Triangle = RSpline::Triangle,
XLine = RSpline::XLine,
Ray = RSpline::Ray,
  ...
  Q_ENUM(Type)
    ...
    */
      ...
      // special constructor to wrap existing object:
            ...
            //Q_INVOKABLE 
            RSpline_Wrapper(RJSApi& h, RSpline* o, bool wrappedCreated);
          
        // special constructor to wrap existing object from shared pointer:
        
            //Q_INVOKABLE 
            RSpline_Wrapper(RJSApi& h, QSharedPointer<RSpline> o);
          

      // destructor:
      
          virtual ~RSpline_Wrapper();
  ...
  a1
    ...
    // preceding Parameters: -1
          ...
          public:
           RSpline* getWrappedClone() {
            RSpline* w = getWrapped();
            if (w==nullptr) {
              qWarning() << "RSpline::getWrappedClone: wrapped is NULL";
              handler.trace();
              return nullptr;
            }
            // return cloned object:
            return new RSpline(*w);
          }
          */
  ...
  // protected overwritten functions / events and their public invokable counterparts:
        ...
        virtual QSharedPointer<RSpline> getWrappedSp() {
          if (!spWrapped.isNull()) {
            return spWrapped;
          }
          if (wrapped!=nullptr) {
            qWarning() << "wrapper does not wrap a QSharedPointer<RSpline> but a regular pointer";
        ...
        RSpline* wrapped;
          ...
          QSharedPointer<RSpline> spWrapped;
      ...
      private:
        ...
        static QList<RJSBasecaster_RSpline*> basecasters_RSpline;

      public:
        static void registerBasecaster_RSpline(RJSBasecaster_RSpline* bc) {
          basecasters_RSpline.append(bc);
        }
      
    };

    Q_DECLARE_METATYPE(RSpline_Wrapper*)

    Q_DECLARE_INTERFACE(RSpline_Wrapper, "org.qcad.RSpline_Wrapper")
