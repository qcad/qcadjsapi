    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                // call function of RMdiArea_Base class as 
                // function has postfix inheritable class, overridable function):
                RMdiArea_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "RMdiArea::mousePressEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                RMdiArea_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "RMdiArea::mouseReleaseEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                RMdiArea_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "RMdiArea::mouseMoveEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                RMdiArea_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "RMdiArea::paintEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                RMdiArea_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "RMdiArea::resizeEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                RMdiArea_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "RMdiArea::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
