  ...
  // Auto generated
    ...
    #ifndef RATTRIBUTEENTITY_H_WRAPPER
    #define RATTRIBUTEENTITY_H_WRAPPER
    ...
    #include <QQmlEngine>
      ...
      class RAttributeEntity_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
  ...
  Q_PROPERTY(
    ...
    QJSValue
     PropertyUpsideDown
      ...
      public:
      //Q_INVOKABLE 
      RAttributeEntity_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  Q_INVOKABLE QJSValue getPropertyLinetypeScale() {
    return RJSHelper_qcad::cpp2js_RPropertyTypeId(handler, RAttributeEntity::PropertyLinetypeScale);
  }

  // auto generated read function for public static property PropertyLineweight:
  Q_INVOKABLE QJSValue getPropertyLineweight() {
    return RJSHelper_qcad::cpp2js_RPropertyTypeId(handler, RAttributeEntity::PropertyLineweight);
  }

  // auto generated read function for public static property PropertyColor:
  Q_INVOKABLE QJSValue getPropertyColor() {
    return RJSHelper_qcad::cpp2js_RPropertyTypeId(handler, RAttributeEntity::PropertyColor);
  }
  ...
  a1
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RAttributeEntity_WrapperSingleton* _singleInstance;
    ...
    // wrapper class for RAttributeEntity
    class RAttributeEntity_Wrapper : public RJSWrapperObj {
    ...
    private:
      ...
      RAttributeEntity_Wrapper(const RAttributeEntity_Wrapper&);

    public:
      // initialization of RAttributeEntity:
      static void init(RJSApi& handler);
        ...
        static RAttributeEntity* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          qWarning() << "RAttributeEntity_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);

          return nullptr;
          
        }

        static RAttributeEntity* getWrappedBase(RJSWrapper* wrapper) {
          int t = wrapper->getWrappedType();
          void* vp = wrapper->getWrappedVoid();
          if (vp==nullptr) {
              //qWarning() << "getWrapped_RAttributeEntity*: wrapper wraps NULL";
          }

          RAttributeEntity* ret = castToBase(vp, t);
          if (ret==nullptr && vp!=nullptr) {
              qWarning() << "RAttributeEntity*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
          }
          return ret;
        }
    ...
    // special constructor used as prototype:
          ...
          Q_INVOKABLE 
          RAttributeEntity_Wrapper(QJSEngine* e);
    ...
    */
      ...
      // special constructor to wrap existing object:
            ...
            //Q_INVOKABLE 
            RAttributeEntity_Wrapper(RJSApi& h, RAttributeEntity* o, bool wrappedCreated);
          
        // special constructor to wrap existing object from shared pointer:
        
            //Q_INVOKABLE 
            RAttributeEntity_Wrapper(RJSApi& h, QSharedPointer<RAttributeEntity> o);
          

      // destructor:
      
          virtual ~RAttributeEntity_Wrapper();
  ...
  // protected overwritten functions / events and their public invokable counterparts:
        ...
        RAttributeEntity* getWrapped() const {
          if (wrapped!=nullptr) {
            return wrapped;
          }
        ...
        virtual QSharedPointer<RAttributeEntity> getWrappedSp() {
          if (!spWrapped.isNull()) {
            return spWrapped;
          }
          if (wrapped!=nullptr) {
            qWarning() << "wrapper does not wrap a QSharedPointer<RAttributeEntity> but a regular pointer";
        ...
        private:
        // wrapped object:
        RAttributeEntity* wrapped;

        
          // wrapped object as shared pointer:
          QSharedPointer<RAttributeEntity> spWrapped;
      ...
      private:
        ...
        static QList<RJSBasecaster_RAttributeEntity*> basecasters_RAttributeEntity;

      public:
        static void registerBasecaster_RAttributeEntity(RJSBasecaster_RAttributeEntity* bc) {
          basecasters_RAttributeEntity.append(bc);
        }
      
    };

    Q_DECLARE_METATYPE(RAttributeEntity_Wrapper*)

    Q_DECLARE_INTERFACE(RAttributeEntity_Wrapper, "org.qcad.RAttributeEntity_Wrapper")
