  ...
  // Auto generated
    ...
    #ifndef RCIRCLE_H_WRAPPER
    #define RCIRCLE_H_WRAPPER
    ...
    #include <QQmlEngine>
     ...
     RCircle_WrapperSingleton: public QObject {
      ...
      public:
      //Q_INVOKABLE 
      RCircle_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a3
      ...
      private:
          RJSApi& handler;
          //static RCircle_WrapperSingleton* _singleInstance;
  ...
  Q_PROPERTY(
    ...
    private:
      ...
      RCircle_Wrapper(const RCircle_Wrapper&);

    public:
      // initialization of RCircle:
      static void init(RJSApi& handler);
        ...
        static RCircle* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RCircle:
          ...
          // object is a pointer to base class RCircle:
        ...
        static RCircle* getWrappedBase(RJSWrapper* wrapper) {
          int t = wrapper->getWrappedType();
          void* vp = wrapper->getWrappedVoid();
          if (vp==nullptr) {
              //qWarning() << "getWrapped_RCircle*: wrapper wraps NULL";
          }

          RCircle* ret = castToBase(vp, t);
          if (ret==nullptr && vp!=nullptr) {
              qWarning() << "RCircle*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
          }
          return ret;
        }
  ...
  enum Type {
    Unknown = RCircle::Unknown,
Point = RCircle::Point,
Line = RCircle::Line,
Arc = RCircle::Arc,
Circle = RCircle::Circle,
Ellipse = RCircle::Ellipse,
Polyline = RCircle::Polyline,
Spline = RCircle::Spline,
Triangle = RCircle::Triangle,
XLine = RCircle::XLine,
Ray = RCircle::Ray,
  ...
  Q_ENUM(Type)
    ...
    */
      ...
      // special constructor to wrap existing object:
            ...
            //Q_INVOKABLE 
            RCircle_Wrapper(RJSApi& h, RCircle* o, bool wrappedCreated);
          
        // special constructor to wrap existing object from shared pointer:
        
            //Q_INVOKABLE 
            RCircle_Wrapper(RJSApi& h, QSharedPointer<RCircle> o);
          

      // destructor:
      
          virtual ~RCircle_Wrapper();
  ...
  a1
    ...
    // preceding Parameters: -1
          ...
          public:
           RCircle* getWrappedClone() {
            RCircle* w = getWrapped();
            if (w==nullptr) {
              qWarning() << "RCircle::getWrappedClone: wrapped is NULL";
              handler.trace();
              return nullptr;
            }
            // return cloned object:
            return new RCircle(*w);
          }
          */
  ...
  // protected overwritten functions / events and their public invokable counterparts:
        ...
        virtual QSharedPointer<RCircle> getWrappedSp() {
          if (!spWrapped.isNull()) {
            return spWrapped;
          }
          if (wrapped!=nullptr) {
            qWarning() << "wrapper does not wrap a QSharedPointer<RCircle> but a regular pointer";
        ...
        RCircle* wrapped;
          ...
          QSharedPointer<RCircle> spWrapped;
    ...
    Q_DECLARE_METATYPE(RCircle_Wrapper*)

    Q_DECLARE_INTERFACE(RCircle_Wrapper, "org.qcad.RCircle_Wrapper")
