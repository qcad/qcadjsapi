  ...
  // Auto generated
    ...
    #ifndef RDIMSTYLE_H_WRAPPER
    #define RDIMSTYLE_H_WRAPPER
    ...
    #include <QQmlEngine>
      ...
      class RDimStyle_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
  ...
  Q_PROPERTY(
    ...
    QJSValue
     PropertyInvisible
      ...
      public:
      //Q_INVOKABLE 
      RDimStyle_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a3
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RDimStyle_WrapperSingleton* _singleInstance;
    ...
    // wrapper class for RDimStyle
    class RDimStyle_Wrapper : public RJSWrapperObj {
    ...
    private:
      ...
      RDimStyle_Wrapper(const RDimStyle_Wrapper&);

    public:
      // initialization of RDimStyle:
      static void init(RJSApi& handler);

      
        static RDimStyle* castToBase(void* vp, /*RJSType ID*/ int t) {
          

          // hook for modules to cast from other types to base RDimStyle:
          for (int i=0; i<basecasters_RDimStyle.length(); i++) {
            RJSBasecaster_RDimStyle* basecaster = basecasters_RDimStyle[i];
            RDimStyle* ret = basecaster->castToBase(t, vp);
            if (ret!=nullptr) {
              return ret;
            }
          }

          // object is a pointer to base class RDimStyle:
        ...
        static RDimStyle* getWrappedBase(RJSWrapper* wrapper) {
          int t = wrapper->getWrappedType();
          void* vp = wrapper->getWrappedVoid();
          if (vp==nullptr) {
              //qWarning() << "getWrapped_RDimStyle*: wrapper wraps NULL";
          }

          RDimStyle* ret = castToBase(vp, t);
          if (ret==nullptr && vp!=nullptr) {
              qWarning() << "RDimStyle*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
          }
          return ret;
        }
    ...
    */
      ...
      // special constructor to wrap existing object:
            ...
            //Q_INVOKABLE 
            RDimStyle_Wrapper(RJSApi& h, RDimStyle* o, bool wrappedCreated);
          
        // special constructor to wrap existing object from shared pointer:
        
            //Q_INVOKABLE 
            RDimStyle_Wrapper(RJSApi& h, QSharedPointer<RDimStyle> o);
          

      // destructor:
      
          virtual ~RDimStyle_Wrapper();
  ...
  // protected overwritten functions / events and their public invokable counterparts:
        ...
        virtual QSharedPointer<RDimStyle> getWrappedSp() {
          if (!spWrapped.isNull()) {
            return spWrapped;
          }
          if (wrapped!=nullptr) {
            qWarning() << "wrapper does not wrap a QSharedPointer<RDimStyle> but a regular pointer";
        ...
        RDimStyle* wrapped;
          ...
          QSharedPointer<RDimStyle> spWrapped;
      ...
      private:
        ...
        static QList<RJSBasecaster_RDimStyle*> basecasters_RDimStyle;

      public:
        static void registerBasecaster_RDimStyle(RJSBasecaster_RDimStyle* bc) {
          basecasters_RDimStyle.append(bc);
        }
      
    };

    Q_DECLARE_METATYPE(RDimStyle_Wrapper*)

    Q_DECLARE_INTERFACE(RDimStyle_Wrapper, "org.qcad.RDimStyle_Wrapper")
