  ...
  // Auto generated
    ...
    #include <QQmlEngine>
     ...
     RCadToolBarPanel_WrapperSingleton: public QObject {
      ...
      public:
      //Q_INVOKABLE 
      RCadToolBarPanel_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a2
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RCadToolBarPanel_WrapperSingleton* _singleInstance;
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RCadToolBarPanel* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          qWarning() << "RCadToolBarPanel_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
  ...
  // protected overwritten functions / events and their public invokable counterparts:
      ...
      private:
        ...
        static QList<RJSBasecaster_RCadToolBarPanel*> basecasters_RCadToolBarPanel;

      public:
        static void registerBasecaster_RCadToolBarPanel(RJSBasecaster_RCadToolBarPanel* bc) {
          basecasters_RCadToolBarPanel.append(bc);
        }
