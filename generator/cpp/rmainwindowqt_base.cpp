  ...
  // preceding Parameters: -1
      ...
      void RMainWindowQt_Base::paintEvent(
      QPaintEvent* event
    ) {

      //qDebug() << "RMainWindowQt_Base::paintEvent()";
...
event
  ...
  void RMainWindowQt_Base::mouseMoveEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "RMainWindowQt_Base::mouseMoveEvent()";
...
event
  ...
  void RMainWindowQt_Base::resizeEvent(
      QResizeEvent* event
    ) {

      //qDebug() << "RMainWindowQt_Base::resizeEvent()";
