  ...
  // preceding Parameters: -1
      ...
      void RMainWindowQt_Base::mousePressEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "RMainWindowQt_Base::mousePressEvent()";
...
event
  ...
  void RMainWindowQt_Base::mouseReleaseEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "RMainWindowQt_Base::mouseReleaseEvent()";
...
event
  ...
  void RMainWindowQt_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "RMainWindowQt_Base::actionEvent()";
...
event
  ...
  void RMainWindowQt_Base::contextMenuEvent(
      QContextMenuEvent* event
    ) {

      //qDebug() << "RMainWindowQt_Base::contextMenuEvent()";
