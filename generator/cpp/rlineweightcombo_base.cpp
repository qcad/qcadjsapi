  ...
  // preceding Parameters: -1
      ...
      void RLineweightCombo_Base::mouseMoveEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "RLineweightCombo_Base::mouseMoveEvent()";
...
event
  ...
  void RLineweightCombo_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "RLineweightCombo_Base::actionEvent()";
...
event
  ...
  void RLineweightCombo_Base::resizeEvent(
      QResizeEvent* e
    ) {

      //qDebug() << "RLineweightCombo_Base::resizeEvent()";
...
e
  ...
  void RLineweightCombo_Base::paintEvent(
      QPaintEvent* e
    ) {

      //qDebug() << "RLineweightCombo_Base::paintEvent()";
