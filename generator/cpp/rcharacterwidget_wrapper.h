  ...
  // Auto generated
    ...
    #include <QQmlEngine>
     ...
     RCharacterWidget_WrapperSingleton: public QObject {
      ...
      public:
      //Q_INVOKABLE 
      RCharacterWidget_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a2
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RCharacterWidget_WrapperSingleton* _singleInstance;
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RCharacterWidget* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RCharacterWidget:
          for (int i=0; i<basecasters_RCharacterWidget.length(); i++) {
            RJSBasecaster_RCharacterWidget* basecaster = basecasters_RCharacterWidget[i];
            RCharacterWidget* ret = basecaster->castToBase(t, vp);
            if (ret!=nullptr) {
              return ret;
            }
          }

          // object is a pointer to base class RCharacterWidget:
  ...
  // protected overwritten functions / events and their public invokable counterparts:
      ...
      private:
        ...
        static QList<RJSBasecaster_RCharacterWidget*> basecasters_RCharacterWidget;

      public:
        static void registerBasecaster_RCharacterWidget(RJSBasecaster_RCharacterWidget* bc) {
          basecasters_RCharacterWidget.append(bc);
        }
