  ...
  // Auto generated
    ...
    #ifndef RBLOCKREFERENCEDATA_H_WRAPPER
    #define RBLOCKREFERENCEDATA_H_WRAPPER
    ...
    #include <QQmlEngine>
      ...
      public:
      //Q_INVOKABLE 
      RBlockReferenceData_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RBlockReferenceData_WrapperSingleton* _singleInstance;
    ...
    private:
      ...
      RBlockReferenceData_Wrapper(const RBlockReferenceData_Wrapper&);

    public:
      // initialization of RBlockReferenceData:
      static void init(RJSApi& handler);
        ...
        static RBlockReferenceData* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RBlockReferenceData:
          ...
          // object is a pointer to base class RBlockReferenceData:
          if (t==RJSType_RBlockReferenceData::getIdStatic()) {
            return (RBlockReferenceData*)vp;
          }

          qWarning() << "RBlockReferenceData_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);

          return nullptr;
          
        }

        static RBlockReferenceData* getWrappedBase(RJSWrapper* wrapper) {
          int t = wrapper->getWrappedType();
          void* vp = wrapper->getWrappedVoid();
          if (vp==nullptr) {
              //qWarning() << "getWrapped_RBlockReferenceData*: wrapper wraps NULL";
          }

          RBlockReferenceData* ret = castToBase(vp, t);
          if (ret==nullptr && vp!=nullptr) {
              qWarning() << "RBlockReferenceData*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
          }
          return ret;
        }
    ...
    // special constructor used as prototype:
          ...
          Q_INVOKABLE 
          RBlockReferenceData_Wrapper(QJSEngine* e);
    ...
    */
      ...
      // special constructor to wrap existing object:
            ...
            //Q_INVOKABLE 
            RBlockReferenceData_Wrapper(RJSApi& h, RBlockReferenceData* o, bool wrappedCreated);
          

      // destructor:
      
          virtual ~RBlockReferenceData_Wrapper();
  ...
  // protected overwritten functions / events and their public invokable counterparts:
        ...
        // get wrapped object:
        RBlockReferenceData* getWrapped() {
          if (wrapped!=nullptr) {
            return wrapped;
          }
        ...
        RBlockReferenceData* getWrapped() const {
          if (wrapped!=nullptr) {
            return wrapped;
          }
    ...
    Q_DECLARE_METATYPE(RBlockReferenceData_Wrapper*)

    Q_DECLARE_INTERFACE(RBlockReferenceData_Wrapper, "org.qcad.RBlockReferenceData_Wrapper")
