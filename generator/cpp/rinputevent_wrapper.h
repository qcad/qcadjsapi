  ...
  // Auto generated
    ...
    class QCADJSAPI_EXPORT 
     RInputEvent_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RInputEvent* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RInputEvent:
          ...
          // object is a pointer to base class RInputEvent:
          if (t==RJSType_RInputEvent::getIdStatic()) {
            return (RInputEvent*)vp;
          }

          qWarning() << "RInputEvent_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
