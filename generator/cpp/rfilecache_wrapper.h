    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RFileCache* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RFileCache:
          for (int i=0; i<basecasters_RFileCache.length(); i++) {
            RJSBasecaster_RFileCache* basecaster = basecasters_RFileCache[i];
            RFileCache* ret = basecaster->castToBase(t, vp);
            if (ret!=nullptr) {
              return ret;
            }
          }

          // object is a pointer to base class RFileCache:
          if (t==RJSType_RFileCache::getIdStatic()) {
            return (RFileCache*)vp;
          }

          qWarning() << "RFileCache_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
  ...
  // protected overwritten functions / events and their public invokable counterparts:
      ...
      private:
        ...
        static QList<RJSBasecaster_RFileCache*> basecasters_RFileCache;

      public:
        static void registerBasecaster_RFileCache(RJSBasecaster_RFileCache* bc) {
          basecasters_RFileCache.append(bc);
        }
