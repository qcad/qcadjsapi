  ...
  //#include "header_cpp.h"
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RLinetypeCombo_WrapperSingleton::tr
              (
...
int a3_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RLinetypeCombo_WrapperSingleton::setTabOrder
              (
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RLinetypeCombo_WrapperSingleton::mouseGrabber
              (
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RLinetypeCombo_WrapperSingleton::keyboardGrabber
              (
    ...
    void RLinetypeCombo_Wrapper::init(RJSApi& handler) {
      ...
      engine->globalObject().setProperty("RLinetypeCombo_Wrapper", mo);
        ...
        // singleton wrapper:
        QJSValue mos = engine->newQMetaObject(&RLinetypeCombo_WrapperSingleton::staticMetaObject);
        engine->globalObject().setProperty("RLinetypeCombo_WrapperSingleton", mos);

        // create instance of singleton wrapper for static functions:
        RLinetypeCombo_WrapperSingleton * s = new RLinetypeCombo_WrapperSingleton(handler);
        engine->globalObject().setProperty("RLinetypeCombo_WrapperSingletonInstance", engine->newQObject(s));
...
Qt::WidgetAttribute a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RLinetypeCombo_Wrapper::paintEngine
              (
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                // call function of RLinetypeCombo_Base class as 
                // function has postfix inheritable class, overridable function):
                RLinetypeCombo_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "RLinetypeCombo::mouseMoveEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                RLinetypeCombo_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "RLinetypeCombo::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                RLinetypeCombo_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "RLinetypeCombo::resizeEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                RLinetypeCombo_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "RLinetypeCombo::paintEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
