  ...
  // Auto generated
    ...
    #ifndef RELLIPSE_H_WRAPPER
    #define RELLIPSE_H_WRAPPER
    ...
    #include <QQmlEngine>
     ...
     REllipse_WrapperSingleton: public QObject {
      ...
      public:
      //Q_INVOKABLE 
      REllipse_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a4
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static REllipse_WrapperSingleton* _singleInstance;
    ...
    private:
      ...
      REllipse_Wrapper(const REllipse_Wrapper&);

    public:
      // initialization of REllipse:
      static void init(RJSApi& handler);
        ...
        static REllipse* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base REllipse:
          ...
          // object is a pointer to base class REllipse:
          if (t==RJSType_REllipse::getIdStatic()) {
            return (REllipse*)vp;
          }

          qWarning() << "REllipse_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);

          return nullptr;
          
        }

        static REllipse* getWrappedBase(RJSWrapper* wrapper) {
          int t = wrapper->getWrappedType();
          void* vp = wrapper->getWrappedVoid();
          if (vp==nullptr) {
              //qWarning() << "getWrapped_REllipse*: wrapper wraps NULL";
          }

          REllipse* ret = castToBase(vp, t);
          if (ret==nullptr && vp!=nullptr) {
              qWarning() << "REllipse*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
          }
          return ret;
        }
  ...
  enum Type {
    Unknown = REllipse::Unknown,
Point = REllipse::Point,
Line = REllipse::Line,
Arc = REllipse::Arc,
Circle = REllipse::Circle,
Ellipse = REllipse::Ellipse,
Polyline = REllipse::Polyline,
Spline = REllipse::Spline,
Triangle = REllipse::Triangle,
XLine = REllipse::XLine,
Ray = REllipse::Ray,
  ...
  Q_ENUM(Type)
    ...
    */
      ...
      // special constructor to wrap existing object:
            ...
            //Q_INVOKABLE 
            REllipse_Wrapper(RJSApi& h, REllipse* o, bool wrappedCreated);
          
        // special constructor to wrap existing object from shared pointer:
        
            //Q_INVOKABLE 
            REllipse_Wrapper(RJSApi& h, QSharedPointer<REllipse> o);
          

      // destructor:
      
          virtual ~REllipse_Wrapper();
  ...
  a1
    ...
    // preceding Parameters: -1
          ...
          public:
           REllipse* getWrappedClone() {
            REllipse* w = getWrapped();
            if (w==nullptr) {
              qWarning() << "REllipse::getWrappedClone: wrapped is NULL";
              handler.trace();
              return nullptr;
            }
            // return cloned object:
            return new REllipse(*w);
          }
          */
  ...
  // protected overwritten functions / events and their public invokable counterparts:
        ...
        virtual QSharedPointer<REllipse> getWrappedSp() {
          if (!spWrapped.isNull()) {
            return spWrapped;
          }
          //if (wrapped!=nullptr) {
        ...
        private:
          ...
          QSharedPointer<REllipse> spWrapped;
    ...
    Q_DECLARE_METATYPE(REllipse_Wrapper*)

    Q_DECLARE_INTERFACE(REllipse_Wrapper, "org.qcad.REllipse_Wrapper")
