    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RFileImporterFactoryAdapter* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RFileImporterFactoryAdapter:
          ...
          // object is a pointer to base class RFileImporterFactoryAdapter:
          if (t==RJSType_RFileImporterFactoryAdapter::getIdStatic()) {
            return (RFileImporterFactoryAdapter*)vp;
          }

          qWarning() << "RFileImporterFactoryAdapter_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
