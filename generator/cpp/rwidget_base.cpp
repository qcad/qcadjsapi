  ...
  // preceding Parameters: -1
      ...
      void RWidget_Base::mousePressEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "RWidget_Base::mousePressEvent()";
...
event
  ...
  void RWidget_Base::mouseReleaseEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "RWidget_Base::mouseReleaseEvent()";
...
event
  ...
  void RWidget_Base::mouseMoveEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "RWidget_Base::mouseMoveEvent()";
...
event
  ...
  void RWidget_Base::paintEvent(
      QPaintEvent* event
    ) {

      //qDebug() << "RWidget_Base::paintEvent()";
...
event
  ...
  void RWidget_Base::resizeEvent(
      QResizeEvent* event
    ) {

      //qDebug() << "RWidget_Base::resizeEvent()";
...
event
  ...
  void RWidget_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "RWidget_Base::actionEvent()";
