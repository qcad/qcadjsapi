  ...
  // Auto generated
    ...
    #include <QQmlEngine>
      ...
      class RGraphicsViewWorker_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
      ...
      public:
      //Q_INVOKABLE 
      RGraphicsViewWorker_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a3
      ...
      private:
          RJSApi& handler;
          //static RGraphicsViewWorker_WrapperSingleton* _singleInstance;
    ...
    // wrapper class for RGraphicsViewWorker
    class RGraphicsViewWorker_Wrapper : public RJSWrapperObj {
  ...
  Q_PROPERTY(
    ...
    private:
      ...
      RGraphicsViewWorker_Wrapper(const RGraphicsViewWorker_Wrapper&);

    public:
      // initialization of RGraphicsViewWorker:
      static void init(RJSApi& handler);

      
        static RGraphicsViewWorker* castToBase(void* vp, /*RJSType ID*/ int t) {
          

          // hook for modules to cast from other types to base RGraphicsViewWorker:
          for (int i=0; i<basecasters_RGraphicsViewWorker.length(); i++) {
            RJSBasecaster_RGraphicsViewWorker* basecaster = basecasters_RGraphicsViewWorker[i];
            RGraphicsViewWorker* ret = basecaster->castToBase(t, vp);
            if (ret!=nullptr) {
              return ret;
            }
          }

          // object is a pointer to base class RGraphicsViewWorker:
          if (t==RJSType_RGraphicsViewWorker::getIdStatic()) {
            return (RGraphicsViewWorker*)vp;
          }

          qWarning() << "RGraphicsViewWorker_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);

          return nullptr;
          
        }

        static RGraphicsViewWorker* getWrappedBase(RJSWrapper* wrapper) {
          int t = wrapper->getWrappedType();
          void* vp = wrapper->getWrappedVoid();
          if (vp==nullptr) {
              //qWarning() << "getWrapped_RGraphicsViewWorker*: wrapper wraps NULL";
          }

          RGraphicsViewWorker* ret = castToBase(vp, t);
          if (ret==nullptr && vp!=nullptr) {
              qWarning() << "RGraphicsViewWorker*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
          }
          return ret;
        }
    ...
    // special constructor used as prototype:
          ...
          Q_INVOKABLE 
          RGraphicsViewWorker_Wrapper(QJSEngine* e);
    ...
    */
      ...
      // special constructor to wrap existing object:
            ...
            //Q_INVOKABLE 
            RGraphicsViewWorker_Wrapper(RJSApi& h, RGraphicsViewWorker* o, bool wrappedCreated);
          

      // destructor:
      
          virtual ~RGraphicsViewWorker_Wrapper();
  ...
  // protected overwritten functions / events and their public invokable counterparts:
        ...
        // get wrapped object:
        RGraphicsViewWorker* getWrapped() {
          if (wrapped!=nullptr) {
            return wrapped;
          }
        ...
        RGraphicsViewWorker* getWrapped() const {
          if (wrapped!=nullptr) {
            return wrapped;
          }
      ...
      private:
        ...
        static QList<RJSBasecaster_RGraphicsViewWorker*> basecasters_RGraphicsViewWorker;

      public:
        static void registerBasecaster_RGraphicsViewWorker(RJSBasecaster_RGraphicsViewWorker* bc) {
          basecasters_RGraphicsViewWorker.append(bc);
        }
      
    };

    Q_DECLARE_METATYPE(RGraphicsViewWorker_Wrapper*)

    Q_DECLARE_INTERFACE(RGraphicsViewWorker_Wrapper, "org.qcad.RGraphicsViewWorker_Wrapper")
    ...
    #include <QQmlEngine>
      ...
      // singleton class wrapper for static functions:
      class RGraphicsViewImage_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
  ...
  a3
    ...
    class RGraphicsViewImage_Wrapper : public RJSWrapperObj {
