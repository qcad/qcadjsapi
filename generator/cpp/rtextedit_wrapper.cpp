...
int a3_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RTextEdit_WrapperSingleton::setTabOrder
              (
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RTextEdit_WrapperSingleton::mouseGrabber
              (
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RTextEdit_WrapperSingleton::keyboardGrabber
              (
    ...
    void RTextEdit_Wrapper::init(RJSApi& handler) {
      ...
      engine->globalObject().setProperty("RTextEdit_Wrapper", mo);
        ...
        // singleton wrapper:
        QJSValue mos = engine->newQMetaObject(&RTextEdit_WrapperSingleton::staticMetaObject);
        engine->globalObject().setProperty("RTextEdit_WrapperSingleton", mos);

        // create instance of singleton wrapper for static functions:
        RTextEdit_WrapperSingleton * s = new RTextEdit_WrapperSingleton(handler);
        engine->globalObject().setProperty("RTextEdit_WrapperSingletonInstance", engine->newQObject(s));
