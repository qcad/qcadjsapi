  ...
  // Auto generated
    ...
    class QCADJSAPI_EXPORT 
     RSnapMiddle_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RSnapMiddle* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RSnapMiddle:
          ...
          // object is a pointer to base class RSnapMiddle:
          if (t==RJSType_RSnapMiddle::getIdStatic()) {
            return (RSnapMiddle*)vp;
          }

          qWarning() << "RSnapMiddle_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
