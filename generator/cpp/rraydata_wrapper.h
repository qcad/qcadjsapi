  ...
  // Auto generated
    ...
    #include <QQmlEngine>
     ...
     RRayData_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
    ...
    class QCADJSAPI_EXPORT 
     RRayData_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RRayData* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RRayData:
          ...
          // object is a pointer to base class RRayData:
          if (t==RJSType_RRayData::getIdStatic()) {
            return (RRayData*)vp;
          }

          qWarning() << "RRayData_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
