  ...
  // preceding Parameters: -1
      ...
      bool RCadToolBar_Base::eventFilter(
      QObject* watched, QEvent* event
    ) {

      //qDebug() << "RCadToolBar_Base::eventFilter()";
...
event
        ...
        if (res.isError()) {
          ...
          return
        RCadToolBar::eventFilter(
          watched, event
        );
      }
    }

  void RCadToolBar_Base::mousePressEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "RCadToolBar_Base::mousePressEvent()";
...
event
  ...
  void RCadToolBar_Base::mouseReleaseEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "RCadToolBar_Base::mouseReleaseEvent()";
...
event
  ...
  void RCadToolBar_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "RCadToolBar_Base::actionEvent()";
...
event
  ...
  void RCadToolBar_Base::paintEvent(
      QPaintEvent* event
    ) {

      //qDebug() << "RCadToolBar_Base::paintEvent()";
...
event
  ...
  void RCadToolBar_Base::mouseMoveEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "RCadToolBar_Base::mouseMoveEvent()";
...
event
  ...
  void RCadToolBar_Base::resizeEvent(
      QResizeEvent* event
    ) {

      //qDebug() << "RCadToolBar_Base::resizeEvent()";
