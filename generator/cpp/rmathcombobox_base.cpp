  ...
  // preceding Parameters: -1
      ...
      void RMathComboBox_Base::mouseMoveEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "RMathComboBox_Base::mouseMoveEvent()";
...
event
  ...
  void RMathComboBox_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "RMathComboBox_Base::actionEvent()";
...
event
  ...
  void RMathComboBox_Base::resizeEvent(
      QResizeEvent* e
    ) {

      //qDebug() << "RMathComboBox_Base::resizeEvent()";
...
e
  ...
  void RMathComboBox_Base::paintEvent(
      QPaintEvent* e
    ) {

      //qDebug() << "RMathComboBox_Base::paintEvent()";
