    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RTextData* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RTextData:
          ...
          // object is a pointer to base class RTextData:
          if (t==RJSType_RTextData::getIdStatic()) {
            return (RTextData*)vp;
          }

          qWarning() << "RTextData_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
