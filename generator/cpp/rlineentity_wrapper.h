  ...
  // Auto generated
    ...
    #ifndef RLINEENTITY_H_WRAPPER
    #define RLINEENTITY_H_WRAPPER
  ...
  Q_PROPERTY(
    ...
    QJSValue
     PropertyTotalLength
      ...
      public:
      //Q_INVOKABLE 
      RLineEntity_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  Q_INVOKABLE QJSValue getPropertyLinetypeScale() {
    return RJSHelper_qcad::cpp2js_RPropertyTypeId(handler, RLineEntity::PropertyLinetypeScale);
  }

  // auto generated read function for public static property PropertyLineweight:
  Q_INVOKABLE QJSValue getPropertyLineweight() {
    return RJSHelper_qcad::cpp2js_RPropertyTypeId(handler, RLineEntity::PropertyLineweight);
  }

  // auto generated read function for public static property PropertyColor:
  Q_INVOKABLE QJSValue getPropertyColor() {
    return RJSHelper_qcad::cpp2js_RPropertyTypeId(handler, RLineEntity::PropertyColor);
  }
  ...
  Q_INVOKABLE QJSValue getPropertyTotalLength() {
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RLineEntity_WrapperSingleton* _singleInstance;
    ...
    private:
      ...
      RLineEntity_Wrapper(const RLineEntity_Wrapper&);

    public:
      // initialization of RLineEntity:
      static void init(RJSApi& handler);

      
        static RLineEntity* castToBase(void* vp, /*RJSType ID*/ int t) {
          

          // hook for modules to cast from other types to base RLineEntity:
          for (int i=0; i<basecasters_RLineEntity.length(); i++) {
            RJSBasecaster_RLineEntity* basecaster = basecasters_RLineEntity[i];
            RLineEntity* ret = basecaster->castToBase(t, vp);
            if (ret!=nullptr) {
              return ret;
            }
          }

          // object is a pointer to base class RLineEntity:
        ...
        static RLineEntity* getWrappedBase(RJSWrapper* wrapper) {
          int t = wrapper->getWrappedType();
          void* vp = wrapper->getWrappedVoid();
          if (vp==nullptr) {
              //qWarning() << "getWrapped_RLineEntity*: wrapper wraps NULL";
          }

          RLineEntity* ret = castToBase(vp, t);
          if (ret==nullptr && vp!=nullptr) {
              qWarning() << "RLineEntity*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
          }
          return ret;
        }
    ...
    // special constructor used as prototype:
          ...
          Q_INVOKABLE 
          RLineEntity_Wrapper(QJSEngine* e);
    ...
    */
      ...
      // special constructor to wrap existing object:
            ...
            //Q_INVOKABLE 
            RLineEntity_Wrapper(RJSApi& h, RLineEntity* o, bool wrappedCreated);
          
        // special constructor to wrap existing object from shared pointer:
        
            //Q_INVOKABLE 
            RLineEntity_Wrapper(RJSApi& h, QSharedPointer<RLineEntity> o);
          

      // destructor:
      
          virtual ~RLineEntity_Wrapper();
  ...
  // protected overwritten functions / events and their public invokable counterparts:
        ...
        virtual QSharedPointer<RLineEntity> getWrappedSp() {
          if (!spWrapped.isNull()) {
            return spWrapped;
          }
          //if (wrapped!=nullptr) {
          //  qWarning() << "wrapper does not wrap a QSharedPointer<RLineEntity> but a regular pointer";
        ...
        private:
          ...
          QSharedPointer<RLineEntity> spWrapped;
      ...
      private:
        ...
        static QList<RJSBasecaster_RLineEntity*> basecasters_RLineEntity;

      public:
        static void registerBasecaster_RLineEntity(RJSBasecaster_RLineEntity* bc) {
          basecasters_RLineEntity.append(bc);
        }
      
    };

    Q_DECLARE_METATYPE(RLineEntity_Wrapper*)

    Q_DECLARE_INTERFACE(RLineEntity_Wrapper, "org.qcad.RLineEntity_Wrapper")
