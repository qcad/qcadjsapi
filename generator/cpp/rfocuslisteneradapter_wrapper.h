    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RFocusListenerAdapter* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RFocusListenerAdapter:
          ...
          // object is a pointer to base class RFocusListenerAdapter:
          if (t==RJSType_RFocusListenerAdapter::getIdStatic()) {
            return (RFocusListenerAdapter*)vp;
          }

          qWarning() << "RFocusListenerAdapter_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
