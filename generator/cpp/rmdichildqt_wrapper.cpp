  ...
  //#include "header_cpp.h"
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RMdiChildQt_WrapperSingleton::tr
              (
...
int a3_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RMdiChildQt_WrapperSingleton::setTabOrder
              (
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RMdiChildQt_WrapperSingleton::mouseGrabber
              (
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RMdiChildQt_WrapperSingleton::keyboardGrabber
              (
    ...
    void RMdiChildQt_Wrapper::init(RJSApi& handler) {
      ...
      engine->globalObject().setProperty("RMdiChildQt_Wrapper", mo);
        ...
        // singleton wrapper:
        QJSValue mos = engine->newQMetaObject(&RMdiChildQt_WrapperSingleton::staticMetaObject);
        engine->globalObject().setProperty("RMdiChildQt_WrapperSingleton", mos);

        // create instance of singleton wrapper for static functions:
        RMdiChildQt_WrapperSingleton * s = new RMdiChildQt_WrapperSingleton(handler);
        engine->globalObject().setProperty("RMdiChildQt_WrapperSingletonInstance", engine->newQObject(s));
...
Qt::WidgetAttribute a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RMdiChildQt_Wrapper::paintEngine
              (
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                if (wb==nullptr) {
                  qWarning() << "RMdiChildQt::mousePressEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                RMdiChildQt_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "RMdiChildQt::mouseReleaseEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                RMdiChildQt_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "RMdiChildQt::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
