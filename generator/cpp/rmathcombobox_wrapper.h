  ...
  // Auto generated
    ...
    #include <QQmlEngine>
     ...
     RMathComboBox_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
      ...
      public:
      //Q_INVOKABLE 
      RMathComboBox_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a2
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RMathComboBox_WrapperSingleton* _singleInstance;
    ...
    class QCADJSAPI_EXPORT 
     RMathComboBox_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RMathComboBox* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RMathComboBox:
          for (int i=0; i<basecasters_RMathComboBox.length(); i++) {
            RJSBasecaster_RMathComboBox* basecaster = basecasters_RMathComboBox[i];
            RMathComboBox* ret = basecaster->castToBase(t, vp);
            if (ret!=nullptr) {
              return ret;
            }
          }

          // object is a pointer to base class RMathComboBox:
  ...
  enum InsertPolicy {
    NoInsert = RMathComboBox::NoInsert,
InsertAtTop = RMathComboBox::InsertAtTop,
InsertAtCurrent = RMathComboBox::InsertAtCurrent,
InsertAtBottom = RMathComboBox::InsertAtBottom,
InsertAfterCurrent = RMathComboBox::InsertAfterCurrent,
InsertBeforeCurrent = RMathComboBox::InsertBeforeCurrent,
InsertAlphabetically = RMathComboBox::InsertAlphabetically,

  };
  Q_ENUM(InsertPolicy)

  enum SizeAdjustPolicy {
    AdjustToContents = RMathComboBox::AdjustToContents,
AdjustToContentsOnFirstShow = RMathComboBox::AdjustToContentsOnFirstShow,
AdjustToMinimumContentsLengthWithIcon = RMathComboBox::AdjustToMinimumContentsLengthWithIcon,
  ...
  // protected overwritten functions / events and their public invokable counterparts:
      ...
      private:
        ...
        static QList<RJSBasecaster_RMathComboBox*> basecasters_RMathComboBox;

      public:
        static void registerBasecaster_RMathComboBox(RJSBasecaster_RMathComboBox* bc) {
          basecasters_RMathComboBox.append(bc);
        }
