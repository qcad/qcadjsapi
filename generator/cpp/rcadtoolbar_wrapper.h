  ...
  // Auto generated
    ...
    #include <QQmlEngine>
     ...
     RCadToolBar_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
      ...
      public:
      //Q_INVOKABLE 
      RCadToolBar_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a2
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RCadToolBar_WrapperSingleton* _singleInstance;
    ...
    class QCADJSAPI_EXPORT 
     RCadToolBar_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RCadToolBar* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RCadToolBar:
          for (int i=0; i<basecasters_RCadToolBar.length(); i++) {
            RJSBasecaster_RCadToolBar* basecaster = basecasters_RCadToolBar[i];
            RCadToolBar* ret = basecaster->castToBase(t, vp);
            if (ret!=nullptr) {
              return ret;
            }
          }

          // object is a pointer to base class RCadToolBar:
  ...
  // protected overwritten functions / events and their public invokable counterparts:
      ...
      private:
        ...
        static QList<RJSBasecaster_RCadToolBar*> basecasters_RCadToolBar;

      public:
        static void registerBasecaster_RCadToolBar(RJSBasecaster_RCadToolBar* bc) {
          basecasters_RCadToolBar.append(bc);
        }
