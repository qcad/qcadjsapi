  ...
  // Auto generated
    ...
    #ifndef RVIEWPORTDATA_H_WRAPPER
    #define RVIEWPORTDATA_H_WRAPPER
    ...
    #include <QQmlEngine>
      ...
      class RViewportData_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
    ...
    class RViewportData_Wrapper : public RJSWrapperObj {
  ...
  Q_PROPERTY(
    ...
    private:
      ...
      RViewportData_Wrapper(const RViewportData_Wrapper&);

    public:
      // initialization of RViewportData:
      static void init(RJSApi& handler);
        ...
        static RViewportData* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          qWarning() << "RViewportData_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);

          return nullptr;
          
        }

        static RViewportData* getWrappedBase(RJSWrapper* wrapper) {
          int t = wrapper->getWrappedType();
          void* vp = wrapper->getWrappedVoid();
          if (vp==nullptr) {
              //qWarning() << "getWrapped_RViewportData*: wrapper wraps NULL";
          }

          RViewportData* ret = castToBase(vp, t);
          if (ret==nullptr && vp!=nullptr) {
              qWarning() << "RViewportData*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
          }
          return ret;
        }
    ...
    // special constructor used as prototype:
          ...
          Q_INVOKABLE 
          RViewportData_Wrapper(QJSEngine* e);
    ...
    */
      ...
      // special constructor to wrap existing object:
            ...
            //Q_INVOKABLE 
            RViewportData_Wrapper(RJSApi& h, RViewportData* o, bool wrappedCreated);
          

      // destructor:
      
          virtual ~RViewportData_Wrapper();
  ...
  // protected overwritten functions / events and their public invokable counterparts:
        ...
        RViewportData* getWrapped() const {
          if (wrapped!=nullptr) {
            return wrapped;
          }
      ...
      private:
        ...
        static QList<RJSBasecaster_RViewportData*> basecasters_RViewportData;

      public:
        static void registerBasecaster_RViewportData(RJSBasecaster_RViewportData* bc) {
          basecasters_RViewportData.append(bc);
        }
      
    };

    Q_DECLARE_METATYPE(RViewportData_Wrapper*)

    Q_DECLARE_INTERFACE(RViewportData_Wrapper, "org.qcad.RViewportData_Wrapper")
