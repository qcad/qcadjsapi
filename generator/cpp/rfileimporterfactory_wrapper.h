  ...
  // Auto generated
    ...
    class QCADJSAPI_EXPORT 
     RFileImporterFactory_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RFileImporterFactory* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RFileImporterFactory:
          ...
          // object is a pointer to base class RFileImporterFactory:
          if (t==RJSType_RFileImporterFactory::getIdStatic()) {
            return (RFileImporterFactory*)vp;
          }

          qWarning() << "RFileImporterFactory_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
