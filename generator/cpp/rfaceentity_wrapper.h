  ...
  // Auto generated
    ...
    #include <QQmlEngine>
     ...
     RFaceEntity_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
  ...
  Q_INVOKABLE QJSValue getPropertyTotalLength() {
    ...
    class QCADJSAPI_EXPORT 
     RFaceEntity_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RFaceEntity* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          qWarning() << "RFaceEntity_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
