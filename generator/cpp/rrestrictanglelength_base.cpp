  ...
  // preceding Parameters: 5
      ...
      void RRestrictAngleLength_Base::showUiOptions(
      
    ) 
    
    {

      //qDebug() << "RRestrictAngleLength_Base::showUiOptions()";
      ...
      if (f.isCallable() /*&& !recFlag*/) {
        ...
        //  engine->throwError("exception in: RRestrictAngleLength::showUiOptions:" + res.toString());
        //}
      ...
      //if (!recFlag) {
        ...
        engine->throwError(QString("function not implemented in JS class: RRestrictAngleLength::showUiOptions"));
      //}

      
          // call implementation of original class:
          return RRestrictAngleLength::showUiOptions(
            
          );
        
    }

  void RRestrictAngleLength_Base::hideUiOptions(
      
    ) 
    
    {

      //qDebug() << "RRestrictAngleLength_Base::hideUiOptions()";
      ...
      if (f.isCallable() /*&& !recFlag*/) {
        ...
        //  engine->throwError("exception in: RRestrictAngleLength::hideUiOptions:" + res.toString());
        //}
      ...
      //if (!recFlag) {
        // function not implemented in JS: exception
        engine->throwError(QString("function not implemented in JS class: RRestrictAngleLength::hideUiOptions"));
      //}

      
          // call implementation of original class:
          return RRestrictAngleLength::hideUiOptions(
