    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RExporter* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RExporter:
          ...
          // object is a pointer to base class RExporter:
          if (t==RJSType_RExporter::getIdStatic()) {
            return (RExporter*)vp;
          }

          qWarning() << "RExporter_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
