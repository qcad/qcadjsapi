  ...
  // preceding Parameters: -1
      ...
      bool RCharacterWidget_Base::eventFilter(
      QObject* watched, QEvent* event
    ) {

      //qDebug() << "RCharacterWidget_Base::eventFilter()";
...
event
  ...
  void RCharacterWidget_Base::mouseMoveEvent(
      ...
      //qDebug() << "RCharacterWidget_Base::mouseMoveEvent()";
...
event
  ...
  void RCharacterWidget_Base::mousePressEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "RCharacterWidget_Base::mousePressEvent()";
...
event
  ...
  void RCharacterWidget_Base::paintEvent(
      QPaintEvent* event
    ) {

      //qDebug() << "RCharacterWidget_Base::paintEvent()";
