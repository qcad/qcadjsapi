  ...
  // Auto generated
    ...
    class QCADJSAPI_EXPORT 
     RDirected_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RDirected* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RDirected:
          ...
          // object is a pointer to base class RDirected:
          if (t==RJSType_RDirected::getIdStatic()) {
            return (RDirected*)vp;
          }

          qWarning() << "RDirected_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
