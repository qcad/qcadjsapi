  ...
  // preceding Parameters: -1
      ...
      void RMdiChildQt_Base::mousePressEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "RMdiChildQt_Base::mousePressEvent()";
...
event
  ...
  void RMdiChildQt_Base::mouseReleaseEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "RMdiChildQt_Base::mouseReleaseEvent()";
...
event
  ...
  void RMdiChildQt_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "RMdiChildQt_Base::actionEvent()";
...
event
  ...
  void RMdiChildQt_Base::paintEvent(
      QPaintEvent* event
    ) {

      //qDebug() << "RMdiChildQt_Base::paintEvent()";
...
event
  ...
  void RMdiChildQt_Base::mouseMoveEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "RMdiChildQt_Base::mouseMoveEvent()";
...
event
  ...
  void RMdiChildQt_Base::resizeEvent(
      QResizeEvent* event
    ) {

      //qDebug() << "RMdiChildQt_Base::resizeEvent()";
