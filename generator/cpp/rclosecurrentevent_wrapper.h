  ...
  // Auto generated
    ...
    #include <QQmlEngine>
     ...
     RCloseCurrentEvent_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
  ...
  a1
    ...
    class QCADJSAPI_EXPORT 
     RCloseCurrentEvent_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RCloseCurrentEvent* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RCloseCurrentEvent:
          ...
          // object is a pointer to base class RCloseCurrentEvent:
