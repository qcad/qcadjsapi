...
int a3_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RComboBox_WrapperSingleton::setTabOrder
              (
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RComboBox_WrapperSingleton::mouseGrabber
              (
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RComboBox_WrapperSingleton::keyboardGrabber
              (
    ...
    void RComboBox_Wrapper::init(RJSApi& handler) {
      ...
      engine->globalObject().setProperty("RComboBox_Wrapper", mo);
        ...
        // singleton wrapper:
        QJSValue mos = engine->newQMetaObject(&RComboBox_WrapperSingleton::staticMetaObject);
        engine->globalObject().setProperty("RComboBox_WrapperSingleton", mos);

        // create instance of singleton wrapper for static functions:
        RComboBox_WrapperSingleton * s = new RComboBox_WrapperSingleton(handler);
        engine->globalObject().setProperty("RComboBox_WrapperSingletonInstance", engine->newQObject(s));
