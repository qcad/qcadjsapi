  ...
  // Auto generated
    ...
    class QCADJSAPI_EXPORT 
     RClickReferencePointOperation_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RClickReferencePointOperation* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RClickReferencePointOperation:
          ...
          // object is a pointer to base class RClickReferencePointOperation:
