  ...
  // Auto generated
    ...
    #ifndef RTEXTBASEDENTITY_H_WRAPPER
    #define RTEXTBASEDENTITY_H_WRAPPER
    ...
    #include <QQmlEngine>
      ...
      class RTextBasedEntity_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
  ...
  Q_PROPERTY(
    ...
    QJSValue
     PropertyUpsideDown
      ...
      public:
      //Q_INVOKABLE 
      RTextBasedEntity_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  Q_INVOKABLE QJSValue getPropertyLinetypeScale() {
    return RJSHelper_qcad::cpp2js_RPropertyTypeId(handler, RTextBasedEntity::PropertyLinetypeScale);
  }

  // auto generated read function for public static property PropertyLineweight:
  Q_INVOKABLE QJSValue getPropertyLineweight() {
    return RJSHelper_qcad::cpp2js_RPropertyTypeId(handler, RTextBasedEntity::PropertyLineweight);
  }

  // auto generated read function for public static property PropertyColor:
  Q_INVOKABLE QJSValue getPropertyColor() {
    return RJSHelper_qcad::cpp2js_RPropertyTypeId(handler, RTextBasedEntity::PropertyColor);
  }
  ...
  a1
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RTextBasedEntity_WrapperSingleton* _singleInstance;
    ...
    // wrapper class for RTextBasedEntity
    class RTextBasedEntity_Wrapper : public RJSWrapperObj {
    ...
    private:
      ...
      RTextBasedEntity_Wrapper(const RTextBasedEntity_Wrapper&);

    public:
      // initialization of RTextBasedEntity:
      static void init(RJSApi& handler);
        ...
        static RTextBasedEntity* getWrappedBase(RJSWrapper* wrapper) {
          int t = wrapper->getWrappedType();
          void* vp = wrapper->getWrappedVoid();
          if (vp==nullptr) {
              //qWarning() << "getWrapped_RTextBasedEntity*: wrapper wraps NULL";
          }

          RTextBasedEntity* ret = castToBase(vp, t);
          if (ret==nullptr && vp!=nullptr) {
              qWarning() << "RTextBasedEntity*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
          }
          return ret;
        }
    ...
    // special constructor used as prototype:
          ...
          Q_INVOKABLE 
          RTextBasedEntity_Wrapper(QJSEngine* e);
    ...
    */
      ...
      // special constructor to wrap existing object:
            ...
            //Q_INVOKABLE 
            RTextBasedEntity_Wrapper(RJSApi& h, RTextBasedEntity* o, bool wrappedCreated);
          
        // special constructor to wrap existing object from shared pointer:
        
            //Q_INVOKABLE 
            RTextBasedEntity_Wrapper(RJSApi& h, QSharedPointer<RTextBasedEntity> o);
          

      // destructor:
      
          virtual ~RTextBasedEntity_Wrapper();
  ...
  // protected overwritten functions / events and their public invokable counterparts:
        ...
        RTextBasedEntity* getWrapped() const {
          if (wrapped!=nullptr) {
            return wrapped;
          }
        ...
        virtual QSharedPointer<RTextBasedEntity> getWrappedSp() {
          if (!spWrapped.isNull()) {
            return spWrapped;
          }
          if (wrapped!=nullptr) {
            qWarning() << "wrapper does not wrap a QSharedPointer<RTextBasedEntity> but a regular pointer";
        ...
        private:
        // wrapped object:
        RTextBasedEntity* wrapped;

        
          // wrapped object as shared pointer:
          QSharedPointer<RTextBasedEntity> spWrapped;
    ...
    Q_DECLARE_METATYPE(RTextBasedEntity_Wrapper*)

    Q_DECLARE_INTERFACE(RTextBasedEntity_Wrapper, "org.qcad.RTextBasedEntity_Wrapper")
