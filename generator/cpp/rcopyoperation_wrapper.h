  ...
  // Auto generated
    ...
    class QCADJSAPI_EXPORT 
     RCopyOperation_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RCopyOperation* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RCopyOperation:
          ...
          // object is a pointer to base class RCopyOperation:
