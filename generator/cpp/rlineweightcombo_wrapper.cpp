  ...
  //#include "header_cpp.h"
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RLineweightCombo_WrapperSingleton::tr
              (
...
int a3_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RLineweightCombo_WrapperSingleton::setTabOrder
              (
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RLineweightCombo_WrapperSingleton::mouseGrabber
              (
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RLineweightCombo_WrapperSingleton::keyboardGrabber
              (
    ...
    void RLineweightCombo_Wrapper::init(RJSApi& handler) {
      ...
      engine->globalObject().setProperty("RLineweightCombo_Wrapper", mo);
        ...
        // singleton wrapper:
        QJSValue mos = engine->newQMetaObject(&RLineweightCombo_WrapperSingleton::staticMetaObject);
        engine->globalObject().setProperty("RLineweightCombo_WrapperSingleton", mos);

        // create instance of singleton wrapper for static functions:
        RLineweightCombo_WrapperSingleton * s = new RLineweightCombo_WrapperSingleton(handler);
        engine->globalObject().setProperty("RLineweightCombo_WrapperSingletonInstance", engine->newQObject(s));
...
Qt::WidgetAttribute a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              RLineweightCombo_Wrapper::paintEngine
              (
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                // call function of RLineweightCombo_Base class as 
                // function has postfix inheritable class, overridable function):
                RLineweightCombo_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "RLineweightCombo::mouseMoveEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                RLineweightCombo_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "RLineweightCombo::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                RLineweightCombo_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "RLineweightCombo::resizeEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                RLineweightCombo_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "RLineweightCombo::paintEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
