  ...
  // Auto generated
    ...
    #include <QQmlEngine>
      ...
      class RCircleData_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
      ...
      public:
      //Q_INVOKABLE 
      RCircleData_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a3
      ...
      private:
          RJSApi& handler;
          //static RCircleData_WrapperSingleton* _singleInstance;
    ...
    class RCircleData_Wrapper : public RJSWrapperObj {
