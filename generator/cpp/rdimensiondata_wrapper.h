  ...
  // Auto generated
    ...
    #ifndef RDIMENSIONDATA_H_WRAPPER
    #define RDIMENSIONDATA_H_WRAPPER
    ...
    #include <QQmlEngine>
      ...
      class RDimensionData_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
    ...
    class RDimensionData_Wrapper : public RJSWrapperObj {
    ...
    private:
      ...
      RDimensionData_Wrapper(const RDimensionData_Wrapper&);

    public:
      // initialization of RDimensionData:
      static void init(RJSApi& handler);
        ...
        static RDimensionData* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RDimensionData:
          ...
          // object is a pointer to base class RDimensionData:
          if (t==RJSType_RDimensionData::getIdStatic()) {
            return (RDimensionData*)vp;
          }

          qWarning() << "RDimensionData_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);

          return nullptr;
          
        }

        static RDimensionData* getWrappedBase(RJSWrapper* wrapper) {
          int t = wrapper->getWrappedType();
          void* vp = wrapper->getWrappedVoid();
          if (vp==nullptr) {
              //qWarning() << "getWrapped_RDimensionData*: wrapper wraps NULL";
          }

          RDimensionData* ret = castToBase(vp, t);
          if (ret==nullptr && vp!=nullptr) {
              qWarning() << "RDimensionData*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
          }
          return ret;
        }
    ...
    // special constructor used as prototype:
          ...
          Q_INVOKABLE 
          RDimensionData_Wrapper(QJSEngine* e);
    ...
    */
      ...
      // special constructor to wrap existing object:
            ...
            //Q_INVOKABLE 
            RDimensionData_Wrapper(RJSApi& h, RDimensionData* o, bool wrappedCreated);
          

      // destructor:
      
          virtual ~RDimensionData_Wrapper();
  ...
  // protected overwritten functions / events and their public invokable counterparts:
        ...
        RDimensionData* getWrapped() const {
          if (wrapped!=nullptr) {
            return wrapped;
          }
    ...
    Q_DECLARE_METATYPE(RDimensionData_Wrapper*)

    Q_DECLARE_INTERFACE(RDimensionData_Wrapper, "org.qcad.RDimensionData_Wrapper")
