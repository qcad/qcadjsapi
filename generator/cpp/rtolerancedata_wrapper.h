  ...
  // Auto generated
    ...
    #ifndef RTOLERANCEDATA_H_WRAPPER
    #define RTOLERANCEDATA_H_WRAPPER
    ...
    #include <QQmlEngine>
     ...
     RToleranceData_WrapperSingleton: public QObject {
      ...
      public:
      //Q_INVOKABLE 
      RToleranceData_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RToleranceData_WrapperSingleton* _singleInstance;
    ...
    private:
      ...
      RToleranceData_Wrapper(const RToleranceData_Wrapper&);

    public:
      // initialization of RToleranceData:
      static void init(RJSApi& handler);
        ...
        static RToleranceData* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          qWarning() << "RToleranceData_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);

          return nullptr;
          
        }

        static RToleranceData* getWrappedBase(RJSWrapper* wrapper) {
          int t = wrapper->getWrappedType();
          void* vp = wrapper->getWrappedVoid();
          if (vp==nullptr) {
              //qWarning() << "getWrapped_RToleranceData*: wrapper wraps NULL";
          }

          RToleranceData* ret = castToBase(vp, t);
          if (ret==nullptr && vp!=nullptr) {
              qWarning() << "RToleranceData*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
          }
          return ret;
        }
    ...
    // special constructor used as prototype:
          ...
          Q_INVOKABLE 
          RToleranceData_Wrapper(QJSEngine* e);
    ...
    */
      ...
      // special constructor to wrap existing object:
            ...
            //Q_INVOKABLE 
            RToleranceData_Wrapper(RJSApi& h, RToleranceData* o, bool wrappedCreated);
          

      // destructor:
      
          virtual ~RToleranceData_Wrapper();
  ...
  // protected overwritten functions / events and their public invokable counterparts:
        ...
        RToleranceData* getWrapped() const {
          if (wrapped!=nullptr) {
            return wrapped;
          }
      ...
      private:
        ...
        static QList<RJSBasecaster_RToleranceData*> basecasters_RToleranceData;

      public:
        static void registerBasecaster_RToleranceData(RJSBasecaster_RToleranceData* bc) {
          basecasters_RToleranceData.append(bc);
        }
      
    };

    Q_DECLARE_METATYPE(RToleranceData_Wrapper*)

    Q_DECLARE_INTERFACE(RToleranceData_Wrapper, "org.qcad.RToleranceData_Wrapper")
