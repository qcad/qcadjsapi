  ...
  // Auto generated
    ...
    class QCADJSAPI_EXPORT 
     RTransactionListener_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RTransactionListener* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RTransactionListener:
          ...
          // object is a pointer to base class RTransactionListener:
          if (t==RJSType_RTransactionListener::getIdStatic()) {
            return (RTransactionListener*)vp;
          }

          qWarning() << "RTransactionListener_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
