  ...
  //#include "header_cpp.h"
    ...
    */
      ...
      RModifiedListener_Wrapper::RModifiedListener_Wrapper(RJSApi& h, RModifiedListener* o, bool wrappedCreated) : RJSWrapperObj(h), wrapped(o), wrappedCreated(wrappedCreated) {
