    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RSnapReference* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RSnapReference:
          ...
          // object is a pointer to base class RSnapReference:
          if (t==RJSType_RSnapReference::getIdStatic()) {
            return (RSnapReference*)vp;
          }

          qWarning() << "RSnapReference_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
