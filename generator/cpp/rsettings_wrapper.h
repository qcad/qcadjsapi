  ...
  // Auto generated
    ...
    #ifndef RSETTINGS_H_WRAPPER
    #define RSETTINGS_H_WRAPPER
    ...
    #include <QQmlEngine>
      ...
      public:
      //Q_INVOKABLE 
      RSettings_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a1
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RSettings_WrapperSingleton* _singleInstance;
    ...
    private:
      ...
      RSettings_Wrapper(const RSettings_Wrapper&);

    public:
      // initialization of RSettings:
      static void init(RJSApi& handler);
        ...
        static RSettings* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          qWarning() << "RSettings_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);

          return nullptr;
          
        }

        static RSettings* getWrappedBase(RJSWrapper* wrapper) {
          int t = wrapper->getWrappedType();
          void* vp = wrapper->getWrappedVoid();
          if (vp==nullptr) {
              //qWarning() << "getWrapped_RSettings*: wrapper wraps NULL";
          }

          RSettings* ret = castToBase(vp, t);
          if (ret==nullptr && vp!=nullptr) {
              qWarning() << "RSettings*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
          }
          return ret;
        }
    ...
    */
      ...
      // special constructor to wrap existing object:
            ...
            //Q_INVOKABLE 
            RSettings_Wrapper(RJSApi& h, RSettings* o, bool wrappedCreated);
          

      // destructor:
      
          virtual ~RSettings_Wrapper();
  ...
  // protected overwritten functions / events and their public invokable counterparts:
      ...
      private:
        ...
        static QList<RJSBasecaster_RSettings*> basecasters_RSettings;

      public:
        static void registerBasecaster_RSettings(RJSBasecaster_RSettings* bc) {
          basecasters_RSettings.append(bc);
        }
      
    };

    Q_DECLARE_METATYPE(RSettings_Wrapper*)

    Q_DECLARE_INTERFACE(RSettings_Wrapper, "org.qcad.RSettings_Wrapper")
