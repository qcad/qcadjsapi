  ...
  // Auto generated
    ...
    #include <QQmlEngine>
     ...
     RRulerQt_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
      ...
      public:
      //Q_INVOKABLE 
      RRulerQt_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a2
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RRulerQt_WrapperSingleton* _singleInstance;
    ...
    class QCADJSAPI_EXPORT 
     RRulerQt_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RRulerQt* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          qWarning() << "RRulerQt_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
...
Shape_Mask = RRulerQt::Shape_Mask,
  ...
  // protected overwritten functions / events and their public invokable counterparts:
      ...
      private:
        ...
        static QList<RJSBasecaster_RRulerQt*> basecasters_RRulerQt;

      public:
        static void registerBasecaster_RRulerQt(RJSBasecaster_RRulerQt* bc) {
          basecasters_RRulerQt.append(bc);
        }
