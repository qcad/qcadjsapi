  ...
  // preceding Parameters: -1
      ...
      void RMdiArea_Base::mousePressEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "RMdiArea_Base::mousePressEvent()";
...
event
  ...
  void RMdiArea_Base::mouseReleaseEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "RMdiArea_Base::mouseReleaseEvent()";
...
event
  ...
  void RMdiArea_Base::mouseMoveEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "RMdiArea_Base::mouseMoveEvent()";
...
event
  ...
  void RMdiArea_Base::paintEvent(
      QPaintEvent* event
    ) {

      //qDebug() << "RMdiArea_Base::paintEvent()";
...
event
  ...
  void RMdiArea_Base::resizeEvent(
      QResizeEvent* event
    ) {

      //qDebug() << "RMdiArea_Base::resizeEvent()";
...
event
  ...
  void RMdiArea_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "RMdiArea_Base::actionEvent()";
