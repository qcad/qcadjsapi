  ...
  // Auto generated
    ...
    #ifndef RSHAPE_H_WRAPPER
    #define RSHAPE_H_WRAPPER
    ...
    #include <QQmlEngine>
     ...
     RShape_WrapperSingleton: public QObject {
      ...
      public:
      //Q_INVOKABLE 
      RShape_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a1
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RShape_WrapperSingleton* _singleInstance;
    ...
    private:
      ...
      RShape_Wrapper(const RShape_Wrapper&);

    public:
      // initialization of RShape:
      static void init(RJSApi& handler);
        ...
        static RShape* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          qWarning() << "RShape_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);

          return nullptr;
          
        }

        static RShape* getWrappedBase(RJSWrapper* wrapper) {
          int t = wrapper->getWrappedType();
          void* vp = wrapper->getWrappedVoid();
          if (vp==nullptr) {
              //qWarning() << "getWrapped_RShape*: wrapper wraps NULL";
          }

          RShape* ret = castToBase(vp, t);
          if (ret==nullptr && vp!=nullptr) {
              qWarning() << "RShape*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
          }
          return ret;
        }
  ...
  enum Type {
    Unknown = RShape::Unknown,
Point = RShape::Point,
Line = RShape::Line,
Arc = RShape::Arc,
Circle = RShape::Circle,
Ellipse = RShape::Ellipse,
Polyline = RShape::Polyline,
Spline = RShape::Spline,
Triangle = RShape::Triangle,
XLine = RShape::XLine,
Ray = RShape::Ray,
  ...
  Q_ENUM(Type)
    ...
    */
      ...
      // special constructor to wrap existing object:
            ...
            //Q_INVOKABLE 
            RShape_Wrapper(RJSApi& h, RShape* o, bool wrappedCreated);
          
        // special constructor to wrap existing object from shared pointer:
        
            //Q_INVOKABLE 
            RShape_Wrapper(RJSApi& h, QSharedPointer<RShape> o);
          

      // destructor:
      
          virtual ~RShape_Wrapper();
  ...
  // protected overwritten functions / events and their public invokable counterparts:
        ...
        virtual QSharedPointer<RShape> getWrappedSp() {
          if (!spWrapped.isNull()) {
            return spWrapped;
          }
          //if (wrapped!=nullptr) {
          //  qWarning() << "wrapper does not wrap a QSharedPointer<RShape> but a regular pointer";
        ...
        private:
          ...
          QSharedPointer<RShape> spWrapped;
    ...
    Q_DECLARE_METATYPE(RShape_Wrapper*)

    Q_DECLARE_INTERFACE(RShape_Wrapper, "org.qcad.RShape_Wrapper")
