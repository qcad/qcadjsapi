...
RS::EntityType a1_cpp;
    ...
    */
      ...
      RTextEntity_Wrapper::RTextEntity_Wrapper(RJSApi& h, RTextEntity* o, bool wrappedCreated) : RJSWrapperObj(h), 
        ...
        RTextEntity_Wrapper::RTextEntity_Wrapper(RJSApi& h, QSharedPointer<RTextEntity> o) : RJSWrapperObj(h), spWrapped(o), wrappedCreated(false) {
              //RDebug::incCounter(QString("RTextEntity_Wrapper_") + handler.getEngine()->objectName());
              //RDebug::incCounter(QString("RTextEntity_Wrapper"));
              //setObjectName("RTextEntity_Wrapper");
              //setHandler(h);
...
RTextData a2_cpp;
    ...
    // call function:
        ...
        // construct wrapper:
              ...
              spWrapped = QSharedPointer<RTextEntity>(new RTextEntity(
                  a1_cpp
    , a2_cpp
