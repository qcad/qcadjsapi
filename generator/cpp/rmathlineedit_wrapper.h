  ...
  // Auto generated
    ...
    #include <QQmlEngine>
     ...
     RMathLineEdit_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
      ...
      public:
      //Q_INVOKABLE 
      RMathLineEdit_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a2
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static RMathLineEdit_WrapperSingleton* _singleInstance;
    ...
    class QCADJSAPI_EXPORT 
     RMathLineEdit_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static RMathLineEdit* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base RMathLineEdit:
          for (int i=0; i<basecasters_RMathLineEdit.length(); i++) {
            RJSBasecaster_RMathLineEdit* basecaster = basecasters_RMathLineEdit[i];
            RMathLineEdit* ret = basecaster->castToBase(t, vp);
            if (ret!=nullptr) {
              return ret;
            }
          }

          // object is a pointer to base class RMathLineEdit:
  ...
  enum ActionPosition {
    LeadingPosition = RMathLineEdit::LeadingPosition,
TrailingPosition = RMathLineEdit::TrailingPosition,

  };
  Q_ENUM(ActionPosition)

  enum EchoMode {
    Normal = RMathLineEdit::Normal,
NoEcho = RMathLineEdit::NoEcho,
Password = RMathLineEdit::Password,
PasswordEchoOnEdit = RMathLineEdit::PasswordEchoOnEdit,
  ...
  // protected overwritten functions / events and their public invokable counterparts:
      ...
      private:
        ...
        static QList<RJSBasecaster_RMathLineEdit*> basecasters_RMathLineEdit;

      public:
        static void registerBasecaster_RMathLineEdit(RJSBasecaster_RMathLineEdit* bc) {
          basecasters_RMathLineEdit.append(bc);
        }
