  ...
  // preceding Parameters: -1
      ...
      void RCommandLine_Base::resizeEvent(
      QResizeEvent* event
    ) {

      //qDebug() << "RCommandLine_Base::resizeEvent()";
...
event
  ...
  void RCommandLine_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "RCommandLine_Base::actionEvent()";
...
event
  ...
  void RCommandLine_Base::mouseMoveEvent(
      QMouseEvent* a1
    ) {

      //qDebug() << "RCommandLine_Base::mouseMoveEvent()";
...
a1
  ...
  void RCommandLine_Base::paintEvent(
      QPaintEvent* a1
    ) {

      //qDebug() << "RCommandLine_Base::paintEvent()";
