    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RDimAngular2LEntity.setCustomPropertyAttributes = function() 
          
        {
          //print("JS: RDimAngular2LEntity.setCustomPropertyAttributes");
          
      if (arguments.length == 3) {
    
                // calling static wrapper:
                return RDimAngular2LEntity_WrapperSingletonInstance.setCustomPropertyAttributes(
        ...
        print("RDimAngular2LEntity.setCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimAngular2LEntity.getCustomPropertyAttributes = function() 
          
        {
          //print("JS: RDimAngular2LEntity.getCustomPropertyAttributes");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RDimAngular2LEntity_WrapperSingletonInstance.getCustomPropertyAttributes(
                  arguments[0], arguments[1]
                );
        ...
        print("RDimAngular2LEntity.getCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimAngular2LEntity.setMember = function() 
          
        {
          //print("JS: RDimAngular2LEntity.setMember");
          
        };
      

        // static function 
        RDimAngular2LEntity.setMemberX = function() 
          
        {
          //print("JS: RDimAngular2LEntity.setMemberX");
          
        };
      

        // static function 
        RDimAngular2LEntity.setMemberY = function() 
          
        {
          //print("JS: RDimAngular2LEntity.setMemberY");
          
        };
      

        // static function 
        RDimAngular2LEntity.setMemberZ = function() 
          
        {
          //print("JS: RDimAngular2LEntity.setMemberZ");
          
        };
      

        // static function 
        RDimAngular2LEntity.setMemberVector = function() 
          
        {
          //print("JS: RDimAngular2LEntity.setMemberVector");
          
        };
      

        // static function 
        RDimAngular2LEntity.isComplex = function() 
          
        {
          //print("JS: RDimAngular2LEntity.isComplex");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RDimAngular2LEntity_WrapperSingletonInstance.isComplex(
                  arguments[0]
                );
        ...
        print("RDimAngular2LEntity.isComplex(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimAngular2LEntity.isDimension = function() 
          
        {
          //print("JS: RDimAngular2LEntity.isDimension");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RDimAngular2LEntity_WrapperSingletonInstance.isDimension(
                  arguments[0]
                );
        ...
        print("RDimAngular2LEntity.isDimension(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimAngular2LEntity.isTextBased = function() 
          
        {
          //print("JS: RDimAngular2LEntity.isTextBased");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RDimAngular2LEntity_WrapperSingletonInstance.isTextBased(
                  arguments[0]
                );
        ...
        print("RDimAngular2LEntity.isTextBased(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimAngular2LEntity.renderDimensionText = function() 
          
        {
          //print("JS: RDimAngular2LEntity.renderDimensionText");
          
      if (arguments.length >= 3 &&
          arguments.length <= 5) {
    
                // calling static wrapper:
                return RDimAngular2LEntity_WrapperSingletonInstance.renderDimensionText(
        ...
        print("RDimAngular2LEntity.renderDimensionText(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimAngular2LEntity.getDimensionBlockNames = function() 
          
        {
          //print("JS: RDimAngular2LEntity.getDimensionBlockNames");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RDimAngular2LEntity_WrapperSingletonInstance.getDimensionBlockNames(
                  arguments[0]
                );
        ...
        print("RDimAngular2LEntity.getDimensionBlockNames(): wrong number / type of arguments");
