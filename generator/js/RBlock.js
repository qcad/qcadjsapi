    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RBlock.setCustomPropertyAttributes = function() 
          
        {
          //print("JS: RBlock.setCustomPropertyAttributes");
          
      if (arguments.length == 3) {
    
                // calling static wrapper:
                return RBlock_WrapperSingletonInstance.setCustomPropertyAttributes(
                  arguments[0], arguments[1], arguments[2]
                );
        ...
        print("RBlock.setCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RBlock.getCustomPropertyAttributes = function() 
          
        {
          //print("JS: RBlock.getCustomPropertyAttributes");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RBlock_WrapperSingletonInstance.getCustomPropertyAttributes(
        ...
        print("RBlock.getCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RBlock.setMember = function() 
          
        {
          //print("JS: RBlock.setMember");
          
        };
      

        // static function 
        RBlock.setMemberX = function() 
          
        {
          //print("JS: RBlock.setMemberX");
          
        };
      

        // static function 
        RBlock.setMemberY = function() 
          
        {
          //print("JS: RBlock.setMemberY");
          
        };
      

        // static function 
        RBlock.setMemberZ = function() 
          
        {
          //print("JS: RBlock.setMemberZ");
          
        };
      

        // static function 
        RBlock.setMemberVector = function() 
          
        {
          //print("JS: RBlock.setMemberVector");
