    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RFlowLayout.tr = function() 
          
        {
          //print("JS: RFlowLayout.tr");
          
      if (arguments.length >= 1 &&
          arguments.length <= 3) {
    
                // calling static wrapper:
                return RFlowLayout_WrapperSingletonInstance.tr(
                  arguments[0], arguments[1], arguments[2]
                );
        ...
        print("RFlowLayout.tr(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RFlowLayout.closestAcceptableSize = function() 
          
        {
          //print("JS: RFlowLayout.closestAcceptableSize");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RFlowLayout_WrapperSingletonInstance.closestAcceptableSize(
        ...
        print("RFlowLayout.closestAcceptableSize(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RFlowLayout.activateRecursiveHelper = function() 
          
        {
          //print("JS: RFlowLayout.activateRecursiveHelper");
