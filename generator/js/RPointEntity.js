    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RPointEntity.setCustomPropertyAttributes = function() 
          
        {
          //print("JS: RPointEntity.setCustomPropertyAttributes");
          
      if (arguments.length == 3) {
    
                // calling static wrapper:
                return RPointEntity_WrapperSingletonInstance.setCustomPropertyAttributes(
        ...
        print("RPointEntity.setCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RPointEntity.getCustomPropertyAttributes = function() 
          
        {
          //print("JS: RPointEntity.getCustomPropertyAttributes");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RPointEntity_WrapperSingletonInstance.getCustomPropertyAttributes(
                  arguments[0], arguments[1]
                );
        ...
        print("RPointEntity.getCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RPointEntity.setMember = function() 
          
        {
          //print("JS: RPointEntity.setMember");
          
        };
      

        // static function 
        RPointEntity.setMemberX = function() 
          
        {
          //print("JS: RPointEntity.setMemberX");
          
        };
      

        // static function 
        RPointEntity.setMemberY = function() 
          
        {
          //print("JS: RPointEntity.setMemberY");
          
        };
      

        // static function 
        RPointEntity.setMemberZ = function() 
          
        {
          //print("JS: RPointEntity.setMemberZ");
          
        };
      

        // static function 
        RPointEntity.setMemberVector = function() 
          
        {
          //print("JS: RPointEntity.setMemberVector");
          
        };
      

        // static function 
        RPointEntity.isComplex = function() 
          
        {
          //print("JS: RPointEntity.isComplex");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RPointEntity_WrapperSingletonInstance.isComplex(
                  arguments[0]
                );
        ...
        print("RPointEntity.isComplex(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RPointEntity.isDimension = function() 
          
        {
          //print("JS: RPointEntity.isDimension");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RPointEntity_WrapperSingletonInstance.isDimension(
                  arguments[0]
                );
        ...
        print("RPointEntity.isDimension(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RPointEntity.isTextBased = function() 
          
        {
          //print("JS: RPointEntity.isTextBased");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RPointEntity_WrapperSingletonInstance.isTextBased(
                  arguments[0]
                );
        ...
        print("RPointEntity.isTextBased(): wrong number / type of arguments");
