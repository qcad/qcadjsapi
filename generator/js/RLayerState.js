    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RLayerState.setCustomPropertyAttributes = function() 
          
        {
          //print("JS: RLayerState.setCustomPropertyAttributes");
          
      if (arguments.length == 3) {
    
                // calling static wrapper:
                return RLayerState_WrapperSingletonInstance.setCustomPropertyAttributes(
        ...
        print("RLayerState.setCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RLayerState.getCustomPropertyAttributes = function() 
          
        {
          //print("JS: RLayerState.getCustomPropertyAttributes");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RLayerState_WrapperSingletonInstance.getCustomPropertyAttributes(
                  arguments[0], arguments[1]
                );
        ...
        print("RLayerState.getCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RLayerState.setMember = function() 
          
        {
          //print("JS: RLayerState.setMember");
          
        };
      

        // static function 
        RLayerState.setMemberX = function() 
          
        {
          //print("JS: RLayerState.setMemberX");
          
        };
      

        // static function 
        RLayerState.setMemberY = function() 
          
        {
          //print("JS: RLayerState.setMemberY");
          
        };
      

        // static function 
        RLayerState.setMemberZ = function() 
          
        {
          //print("JS: RLayerState.setMemberZ");
          
        };
      

        // static function 
        RLayerState.setMemberVector = function() 
          
        {
          //print("JS: RLayerState.setMemberVector");
