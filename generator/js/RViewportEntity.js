    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RViewportEntity.setCustomPropertyAttributes = function() 
          
        {
          //print("JS: RViewportEntity.setCustomPropertyAttributes");
          
      if (arguments.length == 3) {
    
                // calling static wrapper:
                return RViewportEntity_WrapperSingletonInstance.setCustomPropertyAttributes(
        ...
        print("RViewportEntity.setCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RViewportEntity.getCustomPropertyAttributes = function() 
          
        {
          //print("JS: RViewportEntity.getCustomPropertyAttributes");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RViewportEntity_WrapperSingletonInstance.getCustomPropertyAttributes(
                  arguments[0], arguments[1]
                );
        ...
        print("RViewportEntity.getCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RViewportEntity.setMember = function() 
          
        {
          //print("JS: RViewportEntity.setMember");
          
        };
      

        // static function 
        RViewportEntity.setMemberX = function() 
          
        {
          //print("JS: RViewportEntity.setMemberX");
          
        };
      

        // static function 
        RViewportEntity.setMemberY = function() 
          
        {
          //print("JS: RViewportEntity.setMemberY");
          
        };
      

        // static function 
        RViewportEntity.setMemberZ = function() 
          
        {
          //print("JS: RViewportEntity.setMemberZ");
          
        };
      

        // static function 
        RViewportEntity.setMemberVector = function() 
          
        {
          //print("JS: RViewportEntity.setMemberVector");
          
        };
      

        // static function 
        RViewportEntity.isComplex = function() 
          
        {
          //print("JS: RViewportEntity.isComplex");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RViewportEntity_WrapperSingletonInstance.isComplex(
                  arguments[0]
                );
        ...
        print("RViewportEntity.isComplex(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RViewportEntity.isDimension = function() 
          
        {
          //print("JS: RViewportEntity.isDimension");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RViewportEntity_WrapperSingletonInstance.isDimension(
                  arguments[0]
                );
        ...
        print("RViewportEntity.isDimension(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RViewportEntity.isTextBased = function() 
          
        {
          //print("JS: RViewportEntity.isTextBased");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RViewportEntity_WrapperSingletonInstance.isTextBased(
                  arguments[0]
                );
        ...
        print("RViewportEntity.isTextBased(): wrong number / type of arguments");
