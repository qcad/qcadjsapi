    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RDimDiametricEntity.setCustomPropertyAttributes = function() 
          
        {
          //print("JS: RDimDiametricEntity.setCustomPropertyAttributes");
          
      if (arguments.length == 3) {
    
                // calling static wrapper:
                return RDimDiametricEntity_WrapperSingletonInstance.setCustomPropertyAttributes(
        ...
        print("RDimDiametricEntity.setCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimDiametricEntity.getCustomPropertyAttributes = function() 
          
        {
          //print("JS: RDimDiametricEntity.getCustomPropertyAttributes");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RDimDiametricEntity_WrapperSingletonInstance.getCustomPropertyAttributes(
                  arguments[0], arguments[1]
                );
        ...
        print("RDimDiametricEntity.getCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimDiametricEntity.setMember = function() 
          
        {
          //print("JS: RDimDiametricEntity.setMember");
          
        };
      

        // static function 
        RDimDiametricEntity.setMemberX = function() 
          
        {
          //print("JS: RDimDiametricEntity.setMemberX");
          
        };
      

        // static function 
        RDimDiametricEntity.setMemberY = function() 
          
        {
          //print("JS: RDimDiametricEntity.setMemberY");
          
        };
      

        // static function 
        RDimDiametricEntity.setMemberZ = function() 
          
        {
          //print("JS: RDimDiametricEntity.setMemberZ");
          
        };
      

        // static function 
        RDimDiametricEntity.setMemberVector = function() 
          
        {
          //print("JS: RDimDiametricEntity.setMemberVector");
          
        };
      

        // static function 
        RDimDiametricEntity.isComplex = function() 
          
        {
          //print("JS: RDimDiametricEntity.isComplex");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RDimDiametricEntity_WrapperSingletonInstance.isComplex(
                  arguments[0]
                );
        ...
        print("RDimDiametricEntity.isComplex(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimDiametricEntity.isDimension = function() 
          
        {
          //print("JS: RDimDiametricEntity.isDimension");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RDimDiametricEntity_WrapperSingletonInstance.isDimension(
                  arguments[0]
                );
        ...
        print("RDimDiametricEntity.isDimension(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimDiametricEntity.isTextBased = function() 
          
        {
          //print("JS: RDimDiametricEntity.isTextBased");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RDimDiametricEntity_WrapperSingletonInstance.isTextBased(
                  arguments[0]
                );
        ...
        print("RDimDiametricEntity.isTextBased(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimDiametricEntity.renderDimensionText = function() 
          
        {
          //print("JS: RDimDiametricEntity.renderDimensionText");
          
      if (arguments.length >= 3 &&
          arguments.length <= 5) {
    
                // calling static wrapper:
                return RDimDiametricEntity_WrapperSingletonInstance.renderDimensionText(
        ...
        print("RDimDiametricEntity.renderDimensionText(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimDiametricEntity.getDimensionBlockNames = function() 
          
        {
          //print("JS: RDimDiametricEntity.getDimensionBlockNames");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RDimDiametricEntity_WrapperSingletonInstance.getDimensionBlockNames(
                  arguments[0]
                );
        ...
        print("RDimDiametricEntity.getDimensionBlockNames(): wrong number / type of arguments");
