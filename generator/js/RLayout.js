    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RLayout.setCustomPropertyAttributes = function() 
          
        {
          //print("JS: RLayout.setCustomPropertyAttributes");
          
      if (arguments.length == 3) {
    
                // calling static wrapper:
                return RLayout_WrapperSingletonInstance.setCustomPropertyAttributes(
        ...
        print("RLayout.setCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RLayout.getCustomPropertyAttributes = function() 
          
        {
          //print("JS: RLayout.getCustomPropertyAttributes");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RLayout_WrapperSingletonInstance.getCustomPropertyAttributes(
                  arguments[0], arguments[1]
                );
        ...
        print("RLayout.getCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RLayout.setMember = function() 
          
        {
          //print("JS: RLayout.setMember");
          
        };
      

        // static function 
        RLayout.setMemberX = function() 
          
        {
          //print("JS: RLayout.setMemberX");
          
        };
      

        // static function 
        RLayout.setMemberY = function() 
          
        {
          //print("JS: RLayout.setMemberY");
          
        };
      

        // static function 
        RLayout.setMemberZ = function() 
          
        {
          //print("JS: RLayout.setMemberZ");
          
        };
      

        // static function 
        RLayout.setMemberVector = function() 
          
        {
          //print("JS: RLayout.setMemberVector");
