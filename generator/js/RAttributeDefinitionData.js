...
RAttributeDefinitionData.UpsideDown = RAttributeDefinitionData_Wrapper.UpsideDown;
      ...
      // static functions:
        ...
        // static function 
        RAttributeDefinitionData.getRtti = function() 
          
        {
          //print("JS: RAttributeDefinitionData.getRtti");
          
      if (arguments.length == 0) {
    
                // calling static wrapper:
                return RAttributeDefinitionData_WrapperSingletonInstance.getRtti(
        ...
        print("RAttributeDefinitionData.getRtti(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RAttributeDefinitionData.escapeUnicode = function() 
          
        {
          //print("JS: RAttributeDefinitionData.escapeUnicode");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RAttributeDefinitionData_WrapperSingletonInstance.escapeUnicode(
                  arguments[0]
                );
        ...
        print("RAttributeDefinitionData.escapeUnicode(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RAttributeDefinitionData.hasProxy = function() 
          
        {
          //print("JS: RAttributeDefinitionData.hasProxy");
          
      if (arguments.length == 0) {
    
                // calling static wrapper:
                return RAttributeDefinitionData_WrapperSingletonInstance.hasProxy(
        ...
        print("RAttributeDefinitionData.hasProxy(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RAttributeDefinitionData.toEscapedText = function() 
          
        {
          //print("JS: RAttributeDefinitionData.toEscapedText");
          
      if (arguments.length >= 2 &&
          arguments.length <= 4) {
    
                // calling static wrapper:
                return RAttributeDefinitionData_WrapperSingletonInstance.toEscapedText(
        ...
        print("RAttributeDefinitionData.toEscapedText(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RAttributeDefinitionData.toRichText = function() 
          
        {
          //print("JS: RAttributeDefinitionData.toRichText");
          
      if (arguments.length >= 2 &&
          arguments.length <= 3) {
    
                // calling static wrapper:
                return RAttributeDefinitionData_WrapperSingletonInstance.toRichText(
                  arguments[0], arguments[1], arguments[2]
                );
        ...
        print("RAttributeDefinitionData.toRichText(): wrong number / type of arguments");
