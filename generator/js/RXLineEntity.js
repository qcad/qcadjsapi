    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RXLineEntity.setCustomPropertyAttributes = function() 
          
        {
          //print("JS: RXLineEntity.setCustomPropertyAttributes");
          
      if (arguments.length == 3) {
    
                // calling static wrapper:
                return RXLineEntity_WrapperSingletonInstance.setCustomPropertyAttributes(
        ...
        print("RXLineEntity.setCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RXLineEntity.getCustomPropertyAttributes = function() 
          
        {
          //print("JS: RXLineEntity.getCustomPropertyAttributes");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RXLineEntity_WrapperSingletonInstance.getCustomPropertyAttributes(
                  arguments[0], arguments[1]
                );
        ...
        print("RXLineEntity.getCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RXLineEntity.setMember = function() 
          
        {
          //print("JS: RXLineEntity.setMember");
          
        };
      

        // static function 
        RXLineEntity.setMemberX = function() 
          
        {
          //print("JS: RXLineEntity.setMemberX");
          
        };
      

        // static function 
        RXLineEntity.setMemberY = function() 
          
        {
          //print("JS: RXLineEntity.setMemberY");
          
        };
      

        // static function 
        RXLineEntity.setMemberZ = function() 
          
        {
          //print("JS: RXLineEntity.setMemberZ");
          
        };
      

        // static function 
        RXLineEntity.setMemberVector = function() 
          
        {
          //print("JS: RXLineEntity.setMemberVector");
          
        };
      

        // static function 
        RXLineEntity.isComplex = function() 
          
        {
          //print("JS: RXLineEntity.isComplex");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RXLineEntity_WrapperSingletonInstance.isComplex(
                  arguments[0]
                );
        ...
        print("RXLineEntity.isComplex(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RXLineEntity.isDimension = function() 
          
        {
          //print("JS: RXLineEntity.isDimension");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RXLineEntity_WrapperSingletonInstance.isDimension(
                  arguments[0]
                );
        ...
        print("RXLineEntity.isDimension(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RXLineEntity.isTextBased = function() 
          
        {
          //print("JS: RXLineEntity.isTextBased");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RXLineEntity_WrapperSingletonInstance.isTextBased(
                  arguments[0]
                );
        ...
        print("RXLineEntity.isTextBased(): wrong number / type of arguments");
