    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RSpatialIndexNavel.getSIId = function() 
          
        {
          //print("JS: RSpatialIndexNavel.getSIId");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RSpatialIndexNavel_WrapperSingletonInstance.getSIId(
        ...
        print("RSpatialIndexNavel.getSIId(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RSpatialIndexNavel.getId = function() 
          
        {
          //print("JS: RSpatialIndexNavel.getId");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RSpatialIndexNavel_WrapperSingletonInstance.getId(
                  arguments[0]
                );
        ...
        print("RSpatialIndexNavel.getId(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RSpatialIndexNavel.getPos = function() 
          
        {
          //print("JS: RSpatialIndexNavel.getPos");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RSpatialIndexNavel_WrapperSingletonInstance.getPos(
                  arguments[0]
                );
        ...
        print("RSpatialIndexNavel.getPos(): wrong number / type of arguments");
