    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RArcEntity.setCustomPropertyAttributes = function() 
          
        {
          //print("JS: RArcEntity.setCustomPropertyAttributes");
          
      if (arguments.length == 3) {
    
                // calling static wrapper:
                return RArcEntity_WrapperSingletonInstance.setCustomPropertyAttributes(
        ...
        print("RArcEntity.setCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RArcEntity.getCustomPropertyAttributes = function() 
          
        {
          //print("JS: RArcEntity.getCustomPropertyAttributes");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RArcEntity_WrapperSingletonInstance.getCustomPropertyAttributes(
                  arguments[0], arguments[1]
                );
        ...
        print("RArcEntity.getCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RArcEntity.setMember = function() 
          
        {
          //print("JS: RArcEntity.setMember");
          
        };
      

        // static function 
        RArcEntity.setMemberX = function() 
          
        {
          //print("JS: RArcEntity.setMemberX");
          
        };
      

        // static function 
        RArcEntity.setMemberY = function() 
          
        {
          //print("JS: RArcEntity.setMemberY");
          
        };
      

        // static function 
        RArcEntity.setMemberZ = function() 
          
        {
          //print("JS: RArcEntity.setMemberZ");
          
        };
      

        // static function 
        RArcEntity.setMemberVector = function() 
          
        {
          //print("JS: RArcEntity.setMemberVector");
          
        };
      

        // static function 
        RArcEntity.isComplex = function() 
          
        {
          //print("JS: RArcEntity.isComplex");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RArcEntity_WrapperSingletonInstance.isComplex(
                  arguments[0]
                );
        ...
        print("RArcEntity.isComplex(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RArcEntity.isDimension = function() 
          
        {
          //print("JS: RArcEntity.isDimension");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RArcEntity_WrapperSingletonInstance.isDimension(
                  arguments[0]
                );
        ...
        print("RArcEntity.isDimension(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RArcEntity.isTextBased = function() 
          
        {
          //print("JS: RArcEntity.isTextBased");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RArcEntity_WrapperSingletonInstance.isTextBased(
                  arguments[0]
                );
        ...
        print("RArcEntity.isTextBased(): wrong number / type of arguments");
