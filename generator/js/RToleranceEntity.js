    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RToleranceEntity.setCustomPropertyAttributes = function() 
          
        {
          //print("JS: RToleranceEntity.setCustomPropertyAttributes");
          
      if (arguments.length == 3) {
    
                // calling static wrapper:
                return RToleranceEntity_WrapperSingletonInstance.setCustomPropertyAttributes(
        ...
        print("RToleranceEntity.setCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RToleranceEntity.getCustomPropertyAttributes = function() 
          
        {
          //print("JS: RToleranceEntity.getCustomPropertyAttributes");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RToleranceEntity_WrapperSingletonInstance.getCustomPropertyAttributes(
                  arguments[0], arguments[1]
                );
        ...
        print("RToleranceEntity.getCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RToleranceEntity.setMember = function() 
          
        {
          //print("JS: RToleranceEntity.setMember");
          
        };
      

        // static function 
        RToleranceEntity.setMemberX = function() 
          
        {
          //print("JS: RToleranceEntity.setMemberX");
          
        };
      

        // static function 
        RToleranceEntity.setMemberY = function() 
          
        {
          //print("JS: RToleranceEntity.setMemberY");
          
        };
      

        // static function 
        RToleranceEntity.setMemberZ = function() 
          
        {
          //print("JS: RToleranceEntity.setMemberZ");
          
        };
      

        // static function 
        RToleranceEntity.setMemberVector = function() 
          
        {
          //print("JS: RToleranceEntity.setMemberVector");
          
        };
      

        // static function 
        RToleranceEntity.isComplex = function() 
          
        {
          //print("JS: RToleranceEntity.isComplex");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RToleranceEntity_WrapperSingletonInstance.isComplex(
                  arguments[0]
                );
        ...
        print("RToleranceEntity.isComplex(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RToleranceEntity.isDimension = function() 
          
        {
          //print("JS: RToleranceEntity.isDimension");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RToleranceEntity_WrapperSingletonInstance.isDimension(
                  arguments[0]
                );
        ...
        print("RToleranceEntity.isDimension(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RToleranceEntity.isTextBased = function() 
          
        {
          //print("JS: RToleranceEntity.isTextBased");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RToleranceEntity_WrapperSingletonInstance.isTextBased(
                  arguments[0]
                );
        ...
        print("RToleranceEntity.isTextBased(): wrong number / type of arguments");
