    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RImageEntity.setCustomPropertyAttributes = function() 
          
        {
          //print("JS: RImageEntity.setCustomPropertyAttributes");
          
      if (arguments.length == 3) {
    
                // calling static wrapper:
                return RImageEntity_WrapperSingletonInstance.setCustomPropertyAttributes(
        ...
        print("RImageEntity.setCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RImageEntity.getCustomPropertyAttributes = function() 
          
        {
          //print("JS: RImageEntity.getCustomPropertyAttributes");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RImageEntity_WrapperSingletonInstance.getCustomPropertyAttributes(
                  arguments[0], arguments[1]
                );
        ...
        print("RImageEntity.getCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RImageEntity.setMember = function() 
          
        {
          //print("JS: RImageEntity.setMember");
          
        };
      

        // static function 
        RImageEntity.setMemberX = function() 
          
        {
          //print("JS: RImageEntity.setMemberX");
          
        };
      

        // static function 
        RImageEntity.setMemberY = function() 
          
        {
          //print("JS: RImageEntity.setMemberY");
          
        };
      

        // static function 
        RImageEntity.setMemberZ = function() 
          
        {
          //print("JS: RImageEntity.setMemberZ");
          
        };
      

        // static function 
        RImageEntity.setMemberVector = function() 
          
        {
          //print("JS: RImageEntity.setMemberVector");
          
        };
      

        // static function 
        RImageEntity.isComplex = function() 
          
        {
          //print("JS: RImageEntity.isComplex");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RImageEntity_WrapperSingletonInstance.isComplex(
                  arguments[0]
                );
        ...
        print("RImageEntity.isComplex(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RImageEntity.isDimension = function() 
          
        {
          //print("JS: RImageEntity.isDimension");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RImageEntity_WrapperSingletonInstance.isDimension(
                  arguments[0]
                );
        ...
        print("RImageEntity.isDimension(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RImageEntity.isTextBased = function() 
          
        {
          //print("JS: RImageEntity.isTextBased");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RImageEntity_WrapperSingletonInstance.isTextBased(
                  arguments[0]
                );
        ...
        print("RImageEntity.isTextBased(): wrong number / type of arguments");
