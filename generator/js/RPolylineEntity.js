    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RPolylineEntity.setCustomPropertyAttributes = function() 
          
        {
          //print("JS: RPolylineEntity.setCustomPropertyAttributes");
          
      if (arguments.length == 3) {
    
                // calling static wrapper:
                return RPolylineEntity_WrapperSingletonInstance.setCustomPropertyAttributes(
        ...
        print("RPolylineEntity.setCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RPolylineEntity.getCustomPropertyAttributes = function() 
          
        {
          //print("JS: RPolylineEntity.getCustomPropertyAttributes");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RPolylineEntity_WrapperSingletonInstance.getCustomPropertyAttributes(
                  arguments[0], arguments[1]
                );
        ...
        print("RPolylineEntity.getCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RPolylineEntity.setMember = function() 
          
        {
          //print("JS: RPolylineEntity.setMember");
          
        };
      

        // static function 
        RPolylineEntity.setMemberX = function() 
          
        {
          //print("JS: RPolylineEntity.setMemberX");
          
        };
      

        // static function 
        RPolylineEntity.setMemberY = function() 
          
        {
          //print("JS: RPolylineEntity.setMemberY");
          
        };
      

        // static function 
        RPolylineEntity.setMemberZ = function() 
          
        {
          //print("JS: RPolylineEntity.setMemberZ");
          
        };
      

        // static function 
        RPolylineEntity.setMemberVector = function() 
          
        {
          //print("JS: RPolylineEntity.setMemberVector");
          
        };
      

        // static function 
        RPolylineEntity.isComplex = function() 
          
        {
          //print("JS: RPolylineEntity.isComplex");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RPolylineEntity_WrapperSingletonInstance.isComplex(
                  arguments[0]
                );
        ...
        print("RPolylineEntity.isComplex(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RPolylineEntity.isDimension = function() 
          
        {
          //print("JS: RPolylineEntity.isDimension");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RPolylineEntity_WrapperSingletonInstance.isDimension(
                  arguments[0]
                );
        ...
        print("RPolylineEntity.isDimension(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RPolylineEntity.isTextBased = function() 
          
        {
          //print("JS: RPolylineEntity.isTextBased");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RPolylineEntity_WrapperSingletonInstance.isTextBased(
                  arguments[0]
                );
        ...
        print("RPolylineEntity.isTextBased(): wrong number / type of arguments");
