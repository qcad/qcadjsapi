    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RSplineData.getDefaultDrawOrder = function() 
          
        {
          //print("JS: RSplineData.getDefaultDrawOrder");
          
      if (arguments.length == 0) {
    
                // calling static wrapper:
                return RSplineData_WrapperSingletonInstance.getDefaultDrawOrder(
        ...
        print("RSplineData.getDefaultDrawOrder(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RSplineData.createSplinesFromArc = function() 
          
        {
          //print("JS: RSplineData.createSplinesFromArc");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RSplineData_WrapperSingletonInstance.createSplinesFromArc(
                  arguments[0]
                );
        ...
        print("RSplineData.createSplinesFromArc(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RSplineData.createBezierFromSmallArc = function() 
          
        {
          //print("JS: RSplineData.createBezierFromSmallArc");
          
      if (arguments.length == 3) {
    
                // calling static wrapper:
                return RSplineData_WrapperSingletonInstance.createBezierFromSmallArc(
        ...
        print("RSplineData.createBezierFromSmallArc(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RSplineData.hasProxy = function() 
          
        {
          //print("JS: RSplineData.hasProxy");
          
      if (arguments.length == 0) {
    
                // calling static wrapper:
                return RSplineData_WrapperSingletonInstance.hasProxy(
        ...
        print("RSplineData.hasProxy(): wrong number / type of arguments");
