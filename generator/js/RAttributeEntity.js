    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RAttributeEntity.setCustomPropertyAttributes = function() 
          
        {
          //print("JS: RAttributeEntity.setCustomPropertyAttributes");
          
      if (arguments.length == 3) {
    
                // calling static wrapper:
                return RAttributeEntity_WrapperSingletonInstance.setCustomPropertyAttributes(
        ...
        print("RAttributeEntity.setCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RAttributeEntity.getCustomPropertyAttributes = function() 
          
        {
          //print("JS: RAttributeEntity.getCustomPropertyAttributes");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RAttributeEntity_WrapperSingletonInstance.getCustomPropertyAttributes(
                  arguments[0], arguments[1]
                );
        ...
        print("RAttributeEntity.getCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RAttributeEntity.setMember = function() 
          
        {
          //print("JS: RAttributeEntity.setMember");
          
        };
      

        // static function 
        RAttributeEntity.setMemberX = function() 
          
        {
          //print("JS: RAttributeEntity.setMemberX");
          
        };
      

        // static function 
        RAttributeEntity.setMemberY = function() 
          
        {
          //print("JS: RAttributeEntity.setMemberY");
          
        };
      

        // static function 
        RAttributeEntity.setMemberZ = function() 
          
        {
          //print("JS: RAttributeEntity.setMemberZ");
          
        };
      

        // static function 
        RAttributeEntity.setMemberVector = function() 
          
        {
          //print("JS: RAttributeEntity.setMemberVector");
          
        };
      

        // static function 
        RAttributeEntity.isComplex = function() 
          
        {
          //print("JS: RAttributeEntity.isComplex");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RAttributeEntity_WrapperSingletonInstance.isComplex(
                  arguments[0]
                );
        ...
        print("RAttributeEntity.isComplex(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RAttributeEntity.isDimension = function() 
          
        {
          //print("JS: RAttributeEntity.isDimension");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RAttributeEntity_WrapperSingletonInstance.isDimension(
                  arguments[0]
                );
        ...
        print("RAttributeEntity.isDimension(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RAttributeEntity.isTextBased = function() 
          
        {
          //print("JS: RAttributeEntity.isTextBased");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RAttributeEntity_WrapperSingletonInstance.isTextBased(
                  arguments[0]
                );
        ...
        print("RAttributeEntity.isTextBased(): wrong number / type of arguments");
