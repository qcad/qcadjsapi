    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RTextEntity.setCustomPropertyAttributes = function() 
          
        {
          //print("JS: RTextEntity.setCustomPropertyAttributes");
          
      if (arguments.length == 3) {
    
                // calling static wrapper:
                return RTextEntity_WrapperSingletonInstance.setCustomPropertyAttributes(
        ...
        print("RTextEntity.setCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RTextEntity.getCustomPropertyAttributes = function() 
          
        {
          //print("JS: RTextEntity.getCustomPropertyAttributes");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RTextEntity_WrapperSingletonInstance.getCustomPropertyAttributes(
                  arguments[0], arguments[1]
                );
        ...
        print("RTextEntity.getCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RTextEntity.setMember = function() 
          
        {
          //print("JS: RTextEntity.setMember");
          
        };
      

        // static function 
        RTextEntity.setMemberX = function() 
          
        {
          //print("JS: RTextEntity.setMemberX");
          
        };
      

        // static function 
        RTextEntity.setMemberY = function() 
          
        {
          //print("JS: RTextEntity.setMemberY");
          
        };
      

        // static function 
        RTextEntity.setMemberZ = function() 
          
        {
          //print("JS: RTextEntity.setMemberZ");
          
        };
      

        // static function 
        RTextEntity.setMemberVector = function() 
          
        {
          //print("JS: RTextEntity.setMemberVector");
          
        };
      

        // static function 
        RTextEntity.isComplex = function() 
          
        {
          //print("JS: RTextEntity.isComplex");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RTextEntity_WrapperSingletonInstance.isComplex(
                  arguments[0]
                );
        ...
        print("RTextEntity.isComplex(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RTextEntity.isDimension = function() 
          
        {
          //print("JS: RTextEntity.isDimension");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RTextEntity_WrapperSingletonInstance.isDimension(
                  arguments[0]
                );
        ...
        print("RTextEntity.isDimension(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RTextEntity.isTextBased = function() 
          
        {
          //print("JS: RTextEntity.isTextBased");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RTextEntity_WrapperSingletonInstance.isTextBased(
                  arguments[0]
                );
        ...
        print("RTextEntity.isTextBased(): wrong number / type of arguments");
