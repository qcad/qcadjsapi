    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RSolidEntity.setCustomPropertyAttributes = function() 
          
        {
          //print("JS: RSolidEntity.setCustomPropertyAttributes");
          
      if (arguments.length == 3) {
    
                // calling static wrapper:
                return RSolidEntity_WrapperSingletonInstance.setCustomPropertyAttributes(
        ...
        print("RSolidEntity.setCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RSolidEntity.getCustomPropertyAttributes = function() 
          
        {
          //print("JS: RSolidEntity.getCustomPropertyAttributes");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RSolidEntity_WrapperSingletonInstance.getCustomPropertyAttributes(
                  arguments[0], arguments[1]
                );
        ...
        print("RSolidEntity.getCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RSolidEntity.setMember = function() 
          
        {
          //print("JS: RSolidEntity.setMember");
          
        };
      

        // static function 
        RSolidEntity.setMemberX = function() 
          
        {
          //print("JS: RSolidEntity.setMemberX");
          
        };
      

        // static function 
        RSolidEntity.setMemberY = function() 
          
        {
          //print("JS: RSolidEntity.setMemberY");
          
        };
      

        // static function 
        RSolidEntity.setMemberZ = function() 
          
        {
          //print("JS: RSolidEntity.setMemberZ");
          
        };
      

        // static function 
        RSolidEntity.setMemberVector = function() 
          
        {
          //print("JS: RSolidEntity.setMemberVector");
          
        };
      

        // static function 
        RSolidEntity.isComplex = function() 
          
        {
          //print("JS: RSolidEntity.isComplex");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RSolidEntity_WrapperSingletonInstance.isComplex(
                  arguments[0]
                );
        ...
        print("RSolidEntity.isComplex(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RSolidEntity.isDimension = function() 
          
        {
          //print("JS: RSolidEntity.isDimension");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RSolidEntity_WrapperSingletonInstance.isDimension(
                  arguments[0]
                );
        ...
        print("RSolidEntity.isDimension(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RSolidEntity.isTextBased = function() 
          
        {
          //print("JS: RSolidEntity.isTextBased");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RSolidEntity_WrapperSingletonInstance.isTextBased(
                  arguments[0]
                );
        ...
        print("RSolidEntity.isTextBased(): wrong number / type of arguments");
