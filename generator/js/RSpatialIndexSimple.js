    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RSpatialIndexSimple.getSIId = function() 
          
        {
          //print("JS: RSpatialIndexSimple.getSIId");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RSpatialIndexSimple_WrapperSingletonInstance.getSIId(
        ...
        print("RSpatialIndexSimple.getSIId(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RSpatialIndexSimple.getId = function() 
          
        {
          //print("JS: RSpatialIndexSimple.getId");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RSpatialIndexSimple_WrapperSingletonInstance.getId(
                  arguments[0]
                );
        ...
        print("RSpatialIndexSimple.getId(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RSpatialIndexSimple.getPos = function() 
          
        {
          //print("JS: RSpatialIndexSimple.getPos");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RSpatialIndexSimple_WrapperSingletonInstance.getPos(
                  arguments[0]
                );
        ...
        print("RSpatialIndexSimple.getPos(): wrong number / type of arguments");
