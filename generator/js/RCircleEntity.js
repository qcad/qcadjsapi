    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RCircleEntity.setCustomPropertyAttributes = function() 
          
        {
          //print("JS: RCircleEntity.setCustomPropertyAttributes");
          
      if (arguments.length == 3) {
    
                // calling static wrapper:
                return RCircleEntity_WrapperSingletonInstance.setCustomPropertyAttributes(
        ...
        print("RCircleEntity.setCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RCircleEntity.getCustomPropertyAttributes = function() 
          
        {
          //print("JS: RCircleEntity.getCustomPropertyAttributes");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RCircleEntity_WrapperSingletonInstance.getCustomPropertyAttributes(
                  arguments[0], arguments[1]
                );
        ...
        print("RCircleEntity.getCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RCircleEntity.setMember = function() 
          
        {
          //print("JS: RCircleEntity.setMember");
          
        };
      

        // static function 
        RCircleEntity.setMemberX = function() 
          
        {
          //print("JS: RCircleEntity.setMemberX");
          
        };
      

        // static function 
        RCircleEntity.setMemberY = function() 
          
        {
          //print("JS: RCircleEntity.setMemberY");
          
        };
      

        // static function 
        RCircleEntity.setMemberZ = function() 
          
        {
          //print("JS: RCircleEntity.setMemberZ");
          
        };
      

        // static function 
        RCircleEntity.setMemberVector = function() 
          
        {
          //print("JS: RCircleEntity.setMemberVector");
          
        };
      

        // static function 
        RCircleEntity.isComplex = function() 
          
        {
          //print("JS: RCircleEntity.isComplex");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RCircleEntity_WrapperSingletonInstance.isComplex(
                  arguments[0]
                );
        ...
        print("RCircleEntity.isComplex(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RCircleEntity.isDimension = function() 
          
        {
          //print("JS: RCircleEntity.isDimension");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RCircleEntity_WrapperSingletonInstance.isDimension(
                  arguments[0]
                );
        ...
        print("RCircleEntity.isDimension(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RCircleEntity.isTextBased = function() 
          
        {
          //print("JS: RCircleEntity.isTextBased");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RCircleEntity_WrapperSingletonInstance.isTextBased(
                  arguments[0]
                );
        ...
        print("RCircleEntity.isTextBased(): wrong number / type of arguments");
