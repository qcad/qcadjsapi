    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RDimOrdinateEntity.setCustomPropertyAttributes = function() 
          
        {
          //print("JS: RDimOrdinateEntity.setCustomPropertyAttributes");
          
      if (arguments.length == 3) {
    
                // calling static wrapper:
                return RDimOrdinateEntity_WrapperSingletonInstance.setCustomPropertyAttributes(
        ...
        print("RDimOrdinateEntity.setCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimOrdinateEntity.getCustomPropertyAttributes = function() 
          
        {
          //print("JS: RDimOrdinateEntity.getCustomPropertyAttributes");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RDimOrdinateEntity_WrapperSingletonInstance.getCustomPropertyAttributes(
                  arguments[0], arguments[1]
                );
        ...
        print("RDimOrdinateEntity.getCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimOrdinateEntity.setMember = function() 
          
        {
          //print("JS: RDimOrdinateEntity.setMember");
          
        };
      

        // static function 
        RDimOrdinateEntity.setMemberX = function() 
          
        {
          //print("JS: RDimOrdinateEntity.setMemberX");
          
        };
      

        // static function 
        RDimOrdinateEntity.setMemberY = function() 
          
        {
          //print("JS: RDimOrdinateEntity.setMemberY");
          
        };
      

        // static function 
        RDimOrdinateEntity.setMemberZ = function() 
          
        {
          //print("JS: RDimOrdinateEntity.setMemberZ");
          
        };
      

        // static function 
        RDimOrdinateEntity.setMemberVector = function() 
          
        {
          //print("JS: RDimOrdinateEntity.setMemberVector");
          
        };
      

        // static function 
        RDimOrdinateEntity.isComplex = function() 
          
        {
          //print("JS: RDimOrdinateEntity.isComplex");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RDimOrdinateEntity_WrapperSingletonInstance.isComplex(
                  arguments[0]
                );
        ...
        print("RDimOrdinateEntity.isComplex(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimOrdinateEntity.isDimension = function() 
          
        {
          //print("JS: RDimOrdinateEntity.isDimension");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RDimOrdinateEntity_WrapperSingletonInstance.isDimension(
                  arguments[0]
                );
        ...
        print("RDimOrdinateEntity.isDimension(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimOrdinateEntity.isTextBased = function() 
          
        {
          //print("JS: RDimOrdinateEntity.isTextBased");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RDimOrdinateEntity_WrapperSingletonInstance.isTextBased(
                  arguments[0]
                );
        ...
        print("RDimOrdinateEntity.isTextBased(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimOrdinateEntity.renderDimensionText = function() 
          
        {
          //print("JS: RDimOrdinateEntity.renderDimensionText");
          
      if (arguments.length >= 3 &&
          arguments.length <= 5) {
    
                // calling static wrapper:
                return RDimOrdinateEntity_WrapperSingletonInstance.renderDimensionText(
        ...
        print("RDimOrdinateEntity.renderDimensionText(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimOrdinateEntity.getDimensionBlockNames = function() 
          
        {
          //print("JS: RDimOrdinateEntity.getDimensionBlockNames");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RDimOrdinateEntity_WrapperSingletonInstance.getDimensionBlockNames(
                  arguments[0]
                );
        ...
        print("RDimOrdinateEntity.getDimensionBlockNames(): wrong number / type of arguments");
