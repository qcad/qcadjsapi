    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RAttributeDefinitionEntity.setCustomPropertyAttributes = function() 
          
        {
          //print("JS: RAttributeDefinitionEntity.setCustomPropertyAttributes");
          
      if (arguments.length == 3) {
    
                // calling static wrapper:
                return RAttributeDefinitionEntity_WrapperSingletonInstance.setCustomPropertyAttributes(
        ...
        print("RAttributeDefinitionEntity.setCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RAttributeDefinitionEntity.getCustomPropertyAttributes = function() 
          
        {
          //print("JS: RAttributeDefinitionEntity.getCustomPropertyAttributes");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RAttributeDefinitionEntity_WrapperSingletonInstance.getCustomPropertyAttributes(
                  arguments[0], arguments[1]
                );
        ...
        print("RAttributeDefinitionEntity.getCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RAttributeDefinitionEntity.setMember = function() 
          
        {
          //print("JS: RAttributeDefinitionEntity.setMember");
          
        };
      

        // static function 
        RAttributeDefinitionEntity.setMemberX = function() 
          
        {
          //print("JS: RAttributeDefinitionEntity.setMemberX");
          
        };
      

        // static function 
        RAttributeDefinitionEntity.setMemberY = function() 
          
        {
          //print("JS: RAttributeDefinitionEntity.setMemberY");
          
        };
      

        // static function 
        RAttributeDefinitionEntity.setMemberZ = function() 
          
        {
          //print("JS: RAttributeDefinitionEntity.setMemberZ");
          
        };
      

        // static function 
        RAttributeDefinitionEntity.setMemberVector = function() 
          
        {
          //print("JS: RAttributeDefinitionEntity.setMemberVector");
          
        };
      

        // static function 
        RAttributeDefinitionEntity.isComplex = function() 
          
        {
          //print("JS: RAttributeDefinitionEntity.isComplex");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RAttributeDefinitionEntity_WrapperSingletonInstance.isComplex(
                  arguments[0]
                );
        ...
        print("RAttributeDefinitionEntity.isComplex(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RAttributeDefinitionEntity.isDimension = function() 
          
        {
          //print("JS: RAttributeDefinitionEntity.isDimension");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RAttributeDefinitionEntity_WrapperSingletonInstance.isDimension(
                  arguments[0]
                );
        ...
        print("RAttributeDefinitionEntity.isDimension(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RAttributeDefinitionEntity.isTextBased = function() 
          
        {
          //print("JS: RAttributeDefinitionEntity.isTextBased");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RAttributeDefinitionEntity_WrapperSingletonInstance.isTextBased(
                  arguments[0]
                );
        ...
        print("RAttributeDefinitionEntity.isTextBased(): wrong number / type of arguments");
