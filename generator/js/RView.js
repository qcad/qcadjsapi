    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RView.setCustomPropertyAttributes = function() 
          
        {
          //print("JS: RView.setCustomPropertyAttributes");
          
      if (arguments.length == 3) {
    
                // calling static wrapper:
                return RView_WrapperSingletonInstance.setCustomPropertyAttributes(
        ...
        print("RView.setCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RView.getCustomPropertyAttributes = function() 
          
        {
          //print("JS: RView.getCustomPropertyAttributes");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RView_WrapperSingletonInstance.getCustomPropertyAttributes(
        ...
        print("RView.getCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RView.setMember = function() 
          
        {
          //print("JS: RView.setMember");
          
        };
      

        // static function 
        RView.setMemberX = function() 
          
        {
          //print("JS: RView.setMemberX");
          
        };
      

        // static function 
        RView.setMemberY = function() 
          
        {
          //print("JS: RView.setMemberY");
          
        };
      

        // static function 
        RView.setMemberZ = function() 
          
        {
          //print("JS: RView.setMemberZ");
          
        };
      

        // static function 
        RView.setMemberVector = function() 
          
        {
          //print("JS: RView.setMemberVector");
