    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RDimArcLengthEntity.setCustomPropertyAttributes = function() 
          
        {
          //print("JS: RDimArcLengthEntity.setCustomPropertyAttributes");
          
      if (arguments.length == 3) {
    
                // calling static wrapper:
                return RDimArcLengthEntity_WrapperSingletonInstance.setCustomPropertyAttributes(
        ...
        print("RDimArcLengthEntity.setCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimArcLengthEntity.getCustomPropertyAttributes = function() 
          
        {
          //print("JS: RDimArcLengthEntity.getCustomPropertyAttributes");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RDimArcLengthEntity_WrapperSingletonInstance.getCustomPropertyAttributes(
                  arguments[0], arguments[1]
                );
        ...
        print("RDimArcLengthEntity.getCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimArcLengthEntity.setMember = function() 
          
        {
          //print("JS: RDimArcLengthEntity.setMember");
          
        };
      

        // static function 
        RDimArcLengthEntity.setMemberX = function() 
          
        {
          //print("JS: RDimArcLengthEntity.setMemberX");
          
        };
      

        // static function 
        RDimArcLengthEntity.setMemberY = function() 
          
        {
          //print("JS: RDimArcLengthEntity.setMemberY");
          
        };
      

        // static function 
        RDimArcLengthEntity.setMemberZ = function() 
          
        {
          //print("JS: RDimArcLengthEntity.setMemberZ");
          
        };
      

        // static function 
        RDimArcLengthEntity.setMemberVector = function() 
          
        {
          //print("JS: RDimArcLengthEntity.setMemberVector");
          
        };
      

        // static function 
        RDimArcLengthEntity.isComplex = function() 
          
        {
          //print("JS: RDimArcLengthEntity.isComplex");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RDimArcLengthEntity_WrapperSingletonInstance.isComplex(
                  arguments[0]
                );
        ...
        print("RDimArcLengthEntity.isComplex(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimArcLengthEntity.isDimension = function() 
          
        {
          //print("JS: RDimArcLengthEntity.isDimension");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RDimArcLengthEntity_WrapperSingletonInstance.isDimension(
                  arguments[0]
                );
        ...
        print("RDimArcLengthEntity.isDimension(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimArcLengthEntity.isTextBased = function() 
          
        {
          //print("JS: RDimArcLengthEntity.isTextBased");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RDimArcLengthEntity_WrapperSingletonInstance.isTextBased(
                  arguments[0]
                );
        ...
        print("RDimArcLengthEntity.isTextBased(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimArcLengthEntity.renderDimensionText = function() 
          
        {
          //print("JS: RDimArcLengthEntity.renderDimensionText");
          
      if (arguments.length >= 3 &&
          arguments.length <= 5) {
    
                // calling static wrapper:
                return RDimArcLengthEntity_WrapperSingletonInstance.renderDimensionText(
        ...
        print("RDimArcLengthEntity.renderDimensionText(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimArcLengthEntity.getDimensionBlockNames = function() 
          
        {
          //print("JS: RDimArcLengthEntity.getDimensionBlockNames");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RDimArcLengthEntity_WrapperSingletonInstance.getDimensionBlockNames(
                  arguments[0]
                );
        ...
        print("RDimArcLengthEntity.getDimensionBlockNames(): wrong number / type of arguments");
