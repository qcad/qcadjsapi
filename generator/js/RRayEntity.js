    ...
    console.trace();
      ...
      // static functions:
        ...
        // static function 
        RRayEntity.setCustomPropertyAttributes = function() 
          
        {
          //print("JS: RRayEntity.setCustomPropertyAttributes");
          
      if (arguments.length == 3) {
    
                // calling static wrapper:
                return RRayEntity_WrapperSingletonInstance.setCustomPropertyAttributes(
        ...
        print("RRayEntity.setCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RRayEntity.getCustomPropertyAttributes = function() 
          
        {
          //print("JS: RRayEntity.getCustomPropertyAttributes");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RRayEntity_WrapperSingletonInstance.getCustomPropertyAttributes(
                  arguments[0], arguments[1]
                );
        ...
        print("RRayEntity.getCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RRayEntity.setMember = function() 
          
        {
          //print("JS: RRayEntity.setMember");
          
        };
      

        // static function 
        RRayEntity.setMemberX = function() 
          
        {
          //print("JS: RRayEntity.setMemberX");
          
        };
      

        // static function 
        RRayEntity.setMemberY = function() 
          
        {
          //print("JS: RRayEntity.setMemberY");
          
        };
      

        // static function 
        RRayEntity.setMemberZ = function() 
          
        {
          //print("JS: RRayEntity.setMemberZ");
          
        };
      

        // static function 
        RRayEntity.setMemberVector = function() 
          
        {
          //print("JS: RRayEntity.setMemberVector");
          
        };
      

        // static function 
        RRayEntity.isComplex = function() 
          
        {
          //print("JS: RRayEntity.isComplex");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RRayEntity_WrapperSingletonInstance.isComplex(
                  arguments[0]
                );
        ...
        print("RRayEntity.isComplex(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RRayEntity.isDimension = function() 
          
        {
          //print("JS: RRayEntity.isDimension");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RRayEntity_WrapperSingletonInstance.isDimension(
                  arguments[0]
                );
        ...
        print("RRayEntity.isDimension(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RRayEntity.isTextBased = function() 
          
        {
          //print("JS: RRayEntity.isTextBased");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RRayEntity_WrapperSingletonInstance.isTextBased(
                  arguments[0]
                );
        ...
        print("RRayEntity.isTextBased(): wrong number / type of arguments");
