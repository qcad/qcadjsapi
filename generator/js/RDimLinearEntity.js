      ...
      // static functions:
        ...
        // static function 
        RDimLinearEntity.setCustomPropertyAttributes = function() 
          
        {
          //print("JS: RDimLinearEntity.setCustomPropertyAttributes");
          
      if (arguments.length == 3) {
    
                // calling static wrapper:
                return RDimLinearEntity_WrapperSingletonInstance.setCustomPropertyAttributes(
        ...
        print("RDimLinearEntity.setCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimLinearEntity.getCustomPropertyAttributes = function() 
          
        {
          //print("JS: RDimLinearEntity.getCustomPropertyAttributes");
          
      if (arguments.length == 2) {
    
                // calling static wrapper:
                return RDimLinearEntity_WrapperSingletonInstance.getCustomPropertyAttributes(
        ...
        print("RDimLinearEntity.getCustomPropertyAttributes(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimLinearEntity.setMember = function() 
          
        {
          //print("JS: RDimLinearEntity.setMember");
          
        };
      

        // static function 
        RDimLinearEntity.setMemberX = function() 
          
        {
          //print("JS: RDimLinearEntity.setMemberX");
          
        };
      

        // static function 
        RDimLinearEntity.setMemberY = function() 
          
        {
          //print("JS: RDimLinearEntity.setMemberY");
          
        };
      

        // static function 
        RDimLinearEntity.setMemberZ = function() 
          
        {
          //print("JS: RDimLinearEntity.setMemberZ");
          
        };
      

        // static function 
        RDimLinearEntity.setMemberVector = function() 
          
        {
          //print("JS: RDimLinearEntity.setMemberVector");
          
        };
      

        // static function 
        RDimLinearEntity.isComplex = function() 
          
        {
          //print("JS: RDimLinearEntity.isComplex");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RDimLinearEntity_WrapperSingletonInstance.isComplex(
                  arguments[0]
                );
        ...
        print("RDimLinearEntity.isComplex(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimLinearEntity.isDimension = function() 
          
        {
          //print("JS: RDimLinearEntity.isDimension");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RDimLinearEntity_WrapperSingletonInstance.isDimension(
                  arguments[0]
                );
        ...
        print("RDimLinearEntity.isDimension(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimLinearEntity.isTextBased = function() 
          
        {
          //print("JS: RDimLinearEntity.isTextBased");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RDimLinearEntity_WrapperSingletonInstance.isTextBased(
                  arguments[0]
                );
        ...
        print("RDimLinearEntity.isTextBased(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimLinearEntity.getRtti = function() 
          
        {
          //print("JS: RDimLinearEntity.getRtti");
          
      if (arguments.length == 0) {
    
                // calling static wrapper:
                return RDimLinearEntity_WrapperSingletonInstance.getRtti(
        ...
        print("RDimLinearEntity.getRtti(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimLinearEntity.getStaticPropertyTypeIds = function() 
          
        {
          //print("JS: RDimLinearEntity.getStaticPropertyTypeIds");
          
      if (arguments.length == 0) {
    
                // calling static wrapper:
                return RDimLinearEntity_WrapperSingletonInstance.getStaticPropertyTypeIds(
        ...
        print("RDimLinearEntity.getStaticPropertyTypeIds(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimLinearEntity.renderDimensionText = function() 
          
        {
          //print("JS: RDimLinearEntity.renderDimensionText");
          
      if (arguments.length >= 3 &&
          arguments.length <= 5) {
    
                // calling static wrapper:
                return RDimLinearEntity_WrapperSingletonInstance.renderDimensionText(
        ...
        print("RDimLinearEntity.renderDimensionText(): wrong number / type of arguments");
    ...
    console.trace();
        ...
        // static function 
        RDimLinearEntity.getDimensionBlockNames = function() 
          
        {
          //print("JS: RDimLinearEntity.getDimensionBlockNames");
          
      if (arguments.length == 1) {
    
                // calling static wrapper:
                return RDimLinearEntity_WrapperSingletonInstance.getDimensionBlockNames(
                  arguments[0]
                );
        ...
        print("RDimLinearEntity.getDimensionBlockNames(): wrong number / type of arguments");
